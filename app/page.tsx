              ...
              <div className={`w-full px-6 md:px-16 transition-all duration-1000 ${isLoaded && currentSlide === index ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                ...
                <div className="max-w-[800px]">
                  ...
                  <div className="mt-5">
                    <Link
                      href="/get-quote"
                      className="inline-flex items-center gap-2 px-7 py-3 text-[12px] tracking-[0.05em] font-medium bg-[#4a90d9] text-[#0a0f1a] rounded-lg hover:bg-[#5a9ee5] transition-all duration-300"
                    >
