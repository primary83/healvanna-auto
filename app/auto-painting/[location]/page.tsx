...
export async function generateMetadata({
  ...
  const title = `Best ${service.name} in ${city.city}, ${city.stateCode} - Professional Refinishing`;
  const description = `Find the best ${service.name.toLowerCase()} shops in ${city.city}, ${city.stateCode}. Compare master painters with real reviews and professional refinishing services.`;
...
export default async function AutoPaintingLocationPage({
  params,
}: {
  params: Promise<{ location: string }>;
}) {
