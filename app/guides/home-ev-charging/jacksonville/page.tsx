...
export default function JacksonvilleEvChargingGuide() {
  const city = getCityBySlug("jacksonville");
      ...
      <section className="py-8 px-6 bg-[#0d1424]/50">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-xl bg-[#0a0f1a] border border-[#4a90d9]/10">
              <div className="text-2xl font-medium text-[#4a90d9]">JEA</div>
              <div className="text-sm text-[#6b7a94]">Main Utility</div>
            </div>
            <div className="p-4 rounded-xl bg-[#0a0f1a] border border-[#4a90d9]/10">
              <div className="text-2xl font-medium text-[#4a90d9]">$400-$1.6K</div>
          ...
          <div className="mb-12">
            ...
            <div className="p-6 rounded-xl bg-[#0d1424]/50 border border-[#4a90d9]/10">
              <p className="text-[#b8c4d9] mb-4">
                ...
                This means charging a typical EV (with a 60 kWh battery) from 20% to 80% costs approximately <strong className="text-[#e8edf5]">$3.80 - $4.90</strong>.
              </p>
              
              <div className="mt-6 p-4 rounded-lg bg-[#4a90d9]/10 border border-[#4a90d9]/20">
                <h4 className="font-medium text-[#e8edf5] mb-2">💡 Pro Tip: JEA EV Rates</h4>
                <p className="text-sm text-[#b8c4d9]">
                  JEA (Jacksonville&apos;s municipal utility) offers some of the lowest electricity rates in Florida 
                  and has special programs for EV owners. Contact JEA about their EV charging incentives.
                </p>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-[#0a0f1a]">
                    ...
                    <div className="text-2xl font-medium text-[#10b981]">~$32-41</div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#0a0f1a]">
                    <div className="text-sm text-[#6b7a94] mb-1">Gas Car (1,000 miles @ $3.30/gal)</div>
                    <div className="text-2xl font-medium text-[#ef4444]">~$110</div>
                  </div>
                </div>
              </div>
            </div>
