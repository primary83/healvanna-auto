...
export default function TampaEvChargingGuide() {
  const city = getCityBySlug("tampa");
      ...
      <section className="py-8 px-6 bg-[#0d1424]/50">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-xl bg-[#0a0f1a] border border-[#4a90d9]/10">
              <div className="text-2xl font-medium text-[#4a90d9]">TECO</div>
              <div className="text-sm text-[#6b7a94]">Main Utility</div>
            </div>
            <div className="p-4 rounded-xl bg-[#0a0f1a] border border-[#4a90d9]/10">
              <div className="text-2xl font-medium text-[#4a90d9]">$450-$1.8K</div>
          ...
          <div className="mb-12">
            ...
            <div className="p-6 rounded-xl bg-[#0d1424]/50 border border-[#4a90d9]/10">
              <p className="text-[#b8c4d9] mb-4">
                ...
                This means charging a typical EV (with a 60 kWh battery) from 20% to 80% costs approximately <strong className="text-[#e8edf5]">$4.10 - $5.25</strong>.
              </p>
              
              <div className="mt-6 p-4 rounded-lg bg-[#4a90d9]/10 border border-[#4a90d9]/20">
                <h4 className="font-medium text-[#e8edf5] mb-2">💡 Pro Tip: TECO EV Programs</h4>
                <p className="text-sm text-[#b8c4d9]">
                  Tampa Electric (TECO) offers special EV programs including rebates on Level 2 chargers 
                  and time-of-use rates that can reduce your charging costs significantly.
                </p>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-[#0a0f1a]">
                    ...
                    <div className="text-2xl font-medium text-[#10b981]">~$35-44</div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#0a0f1a]">
                    <div className="text-sm text-[#6b7a94] mb-1">Gas Car (1,000 miles @ $3.35/gal)</div>
                    <div className="text-2xl font-medium text-[#ef4444]">~$112</div>
                  </div>
                </div>
              </div>
            </div>
