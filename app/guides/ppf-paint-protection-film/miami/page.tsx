...
const cityData = {
  ...
  slug: "miami",
  state: "FL",
  description: "Miami's intense sun, salt air, and highway debris make PPF essential for protecting your vehicle's paint in South Florida.",
  avgFullFront: "$1,800 - $3,800",
  avgFullBody: "$5,500 - $8,500",
  climate: "Hot, humid, salt air",
  mainConcerns: ["Salt air corrosion", "Intense UV exposure", "I-95 road debris", "Love bugs season"],
  topInstallerTips: [
    "Look for climate-controlled installation bays - Miami's humidity affects adhesion",
    "Ask about ceramic coating combo deals - very popular in Miami for easier cleaning",
    "Check if they offer covered parking during curing - sun is intense here",
    "Verify they use UV-resistant premium films - critical for Florida sun"
  ],
  localConsiderations: [
    "Salt air accelerates paint damage - PPF provides crucial barrier",
    "Love bug season (May & September) - PPF makes cleanup much easier",
    "Intense UV requires top-tier film with UV inhibitors",
    "I-95 and Turnpike debris is brutal on front ends",
    "Many Miami luxury car owners opt for full body coverage"
  ],
  popularPackages: [
    { name: "Full Front + Rocker Panels", price: "$2,800 - $4,200", popular: true },
    { name: "Full Body", price: "$5,500 - $8,500", popular: true },
    { name: "Track Pack", price: "$1,000 - $1,800", popular: false }
  ]
};
...
export default function MiamiPPFGuide() {
