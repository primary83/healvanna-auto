...
const cityData = {
  ...
  slug: "orlando",
  state: "FL",
  description: "Orlando's combination of intense sunshine, love bugs, and I-4 highway debris makes PPF a smart investment for Central Florida drivers.",
  avgFullFront: "$1,600 - $3,500",
  avgFullBody: "$5,000 - $8,000",
  climate: "Hot, humid, sunny",
  mainConcerns: ["I-4 road debris", "Love bugs (twice yearly)", "Intense UV rays", "Theme park parking lots"],
  topInstallerTips: [
    "Central Florida has many XPEL-certified installers - ask for certification proof",
    "Schedule installation during off-peak times for better attention to detail",
    "Ask about indoor curing - Orlando sun can cause issues during initial cure",
    "Many shops offer Tesla-specific packages due to high EV population"
  ],
  localConsiderations: [
    "I-4 construction zones kick up significant debris - full front highly recommended",
    "Love bug season (May & September) is brutal - PPF makes removal much easier",
    "Orlando's UV index is extreme - ensure film has UV inhibitors",
    "High tourism means lots of rental car debris on highways",
    "Theme park parking lots are notorious for door dings - consider door edge guards"
  ],
  popularPackages: [
    { name: "Full Front", price: "$1,600 - $3,500", popular: true },
    { name: "Full Front + Door Edges", price: "$2,200 - $4,000", popular: true },
    { name: "Full Body", price: "$5,000 - $8,000", popular: false }
  ]
};
...
export default function OrlandoPPFGuide() {
