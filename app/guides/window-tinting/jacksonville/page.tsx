...
const cityData = {
  ...
  state: "FL",
  slug: "jacksonville",
  description: "Jacksonville's sprawling layout means more time in your car, making window tinting a practical upgrade for comfort and UV protection during your daily commute.",
  averageCost: "$150-$500",
  popularFilm: "Carbon (best value)",
  localTip: "Jacksonville offers some of Florida's most competitive tinting prices. The market is value-focused with many quality shops offering good deals.",
  climate: "Jacksonville enjoys 221 sunny days per year with hot summers. Being North Florida, it's slightly cooler than South Florida but still benefits greatly from quality tint.",
};

const localShopTips = [
  "Check shops around the Southside and St. Johns Town Center areas",
  "Many Jacksonville shops offer competitive pricing - get multiple quotes",
  "Ask about fleet discounts if you have multiple vehicles",
  "Some shops near the beaches specialize in boat and RV tinting as well",
];

const pricingGuide = [
  { type: "Dyed Film", sedan: "$125-$200", suv: "$175-$275" },
  { type: "Carbon Film", sedan: "$250-$375", suv: "$325-$450" },
  { type: "Ceramic Film", sedan: "$350-$500", suv: "$425-$625" },
];

export default function JacksonvilleWindowTinting() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  const faqs = [
    {
      question: "What's the legal tint limit in Jacksonville?",
      answer: "Jacksonville follows Florida state law: 28% VLT minimum for front side windows, 15% for back side and rear windows on sedans. SUVs and vans can have any darkness on rear windows."
    },
    {
      question: "How much does window tinting cost in Jacksonville?",
      answer: "Jacksonville has some of Florida's most competitive prices, ranging from $125-$500. Basic dyed film starts around $125, while premium ceramic runs $350-$500 for sedans."
    },
    {
      question: "What's the best value tint option in Jacksonville?",
      answer: "Carbon film offers the best balance of performance and price in Jacksonville's market. At $250-$375 for most sedans, you get excellent heat rejection without the premium ceramic price."
    },
    {
      question: "Are there good tint shops in the Beaches area?",
      answer: "Yes, Jacksonville Beach and Neptune Beach have several quality shops that also serve the beaches community. Some specialize in marine applications and understand coastal sun exposure well."
    },
  ];
      ...
      <section className="py-8 px-6 bg-[#0d1424]/50">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 rounded-xl bg-[#0a0f1a] border border-[#4a90d9]/10">
              <div className="text-2xl font-medium text-[#4a90d9]">221 Days</div>
