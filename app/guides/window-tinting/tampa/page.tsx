...
const cityData = {
  ...
  state: "FL",
  slug: "tampa",
  description: "Tampa Bay's sunny climate and beach lifestyle make window tinting a smart investment for UV protection, heat reduction, and interior preservation.",
  averageCost: "$175-$525",
  popularFilm: "Carbon and Ceramic",
  localTip: "Tampa shops often serve the broader Bay Area including St. Pete and Clearwater. Many offer competitive pricing compared to South Florida.",
  climate: "Tampa enjoys 244 sunny days per year with hot, humid summers. The bay area's salt air also makes interior protection particularly important.",
};

const localShopTips = [
  "Check shops in the Westshore and South Tampa areas for quality installations",
  "Many Tampa shops offer package deals that include all windows plus windshield strip",
  "Ask about removal of old tint if your vehicle has existing film",
  "Some shops near MacDill AFB offer military discounts",
];

const pricingGuide = [
  { type: "Dyed Film", sedan: "$150-$225", suv: "$200-$300" },
  { type: "Carbon Film", sedan: "$275-$400", suv: "$350-$475" },
  { type: "Ceramic Film", sedan: "$375-$525", suv: "$450-$650" },
];

export default function TampaWindowTinting() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  const faqs = [
    {
      question: "What's the legal tint limit in Tampa?",
      answer: "Tampa follows Florida state law: 28% VLT minimum for front side windows, 15% for back side and rear windows on sedans. SUVs and vans can have any darkness on rear windows."
    },
    {
      question: "How much does window tinting cost in Tampa?",
      answer: "Tampa pricing is competitive, ranging from $150-$525. You'll typically pay less than Miami but similar to Orlando. Ceramic film runs $375-$525 for most sedans."
    },
    {
      question: "What's the best tint for Tampa's climate?",
      answer: "Ceramic film is ideal for Tampa's hot, sunny climate. It blocks the most heat while maintaining clarity. Carbon film is a good mid-range option if budget is a concern."
    },
    {
      question: "How long does tint last in Tampa's climate?",
      answer: "Quality ceramic film lasts 10+ years, carbon film 8-10 years, and dyed film 3-5 years. Tampa's intense sun can reduce lifespan slightly, making quality film a better investment."
    },
  ];
      ...
      <section className="py-8 px-6 bg-[#0d1424]/50">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 rounded-xl bg-[#0a0f1a] border border-[#4a90d9]/10">
              <div className="text-2xl font-medium text-[#4a90d9]">244 Days</div>
