...
export default function RepairCraftCategory() {
  const navItems = [
    { name: "Home", href: "/" },
  ...
  const articles = [
    {
      ...
      category: "Guide",
      description: "Don't trust your vehicle to just anyone. Learn how to identify reputable collision repair shops, understand certifications, and protect yourself from insurance pressure.",
      ...
      <section className="pt-32 pb-16 px-12 bg-gradient-to-b from-[#0d1424] to-[#0a0f1a]">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-[18px] text-[#6b7a94] leading-relaxed max-w-[700px]">
            Expert guides on finding quality body shops, understanding collision repair, and ensuring your vehicle is restored to perfection.
          </p>
        </div>
      </section>
      ...
      <section className="px-12 pb-24">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mt-8 p-8 bg-[rgba(15,22,40,0.3)] rounded-lg border border-dashed border-[rgba(74,144,217,0.2)] text-center">
            ...
            <div className="text-[#6b7a94] text-xs">We're working on more repair and restoration guides</div>
          </div>
        </div>
      </section>
      ...
      <section className="px-12 pb-24 border-t border-[rgba(74,144,217,0.1)] pt-16">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/insights/category/premium-care" className="p-6 bg-[rgba(15,22,40,0.5)] rounded-lg border border-[rgba(74,144,217,0.15)] hover:border-[rgba(74,144,217,0.3)] transition-all duration-300 group">
              <div className="text-[10px] tracking-[0.2em] uppercase text-[#4a90d9] mb-2 font-medium">Premium Care</div>
              <div className="text-[#6b7a94] text-sm">Detailing, ceramic coating, and PPF guides</div>
            </Link>
