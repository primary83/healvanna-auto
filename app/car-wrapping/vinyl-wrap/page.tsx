...
const data = getSubcategory("car-wrapping", "vinyl-wrap")!;

export const metadata: Metadata = {
  title: `Vinyl Wrap Near You - Professional Vehicle Wraps`,
...
export default function VinylWrapPage() {
  return <ServiceListingPage service={data.service} subcategorySlug="vinyl-wrap" />;
}
