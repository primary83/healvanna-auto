...
function BlogContent() {
  ...
  const categories = ["All", "News", "Guides", "Technology", "Reviews", "Comparison", "Insights", "Trends", "Events"];

  const blogPosts = [
    // May 2-6, 2026 — Beijing Auto Show 2026 cluster (Articles 58-62)
    { id: 402, title: "How \"Future of Intelligence\" Played Out at Auto China 2026", excerpt: "Huawei HIMA, Xiaomi, XPeng, and Chinese AI giants turned Auto China 2026 into a showcase for autonomous driving, smart cockpits, and physical AI.", category: "News", image: "/images/blog/future-of-intelligence-auto-china-2026-hero.png", date: "May 6, 2026", readTime: "10 min read", slug: "future-of-intelligence-auto-china-2026" },
    { id: 401, title: "Why Western Automakers Should Be Worried After Beijing Auto Show 2026", excerpt: "Tesla, Ford, GM, Volkswagen, and BMW all face a Chinese EV market that has changed permanently. Beijing 2026 made the gap impossible to ignore.", category: "News", image: "/images/blog/western-automakers-after-beijing-auto-show-2026-hero.png", date: "May 5, 2026", readTime: "11 min read", slug: "western-automakers-after-beijing-auto-show-2026" },
    { id: 400, title: "Auto China 2026: EV Battery Technology Breakthroughs That Change the Game", excerpt: "CATL's Shenxing solid-state cells, BYD's 1,200V architecture, and ultra-fast charging at scale.", category: "News", image: "/images/blog/auto-china-2026-ev-battery-technology-hero.png", date: "May 4, 2026", readTime: "10 min read", slug: "auto-china-2026-ev-battery-technology" },
    { id: 399, title: "BYD Yangwang, AITO M9, and Nio ES9 — Beijing's Headline Cars Decoded", excerpt: "A deep dive into the three Chinese EVs that defined Beijing Auto Show 2026.", category: "News", image: "/images/blog/byd-yangwang-aito-m9-nio-es9-beijing-2026-hero.png", date: "May 3, 2026", readTime: "10 min read", slug: "byd-yangwang-aito-m9-nio-es9-beijing-2026" },
    { id: 398, title: "Beijing Auto Show 2026: The 10 Most Important Reveals From Auto China", excerpt: "1,451 vehicles, 181 global premieres, 1.28 million visitors. The 10 reveals that will define the next year of the global EV industry.", category: "News", image: "/images/blog/beijing-auto-show-2026-top-10-reveals-hero.png", date: "May 2, 2026", readTime: "8 min read", slug: "beijing-auto-show-2026-top-10-reveals" },
    // April 27, 2026 — Articles 48-57 (battery, buying, charging, ownership, market)
    { id: 397, title: "Best EV Route Planning Apps 2026", excerpt: "The best EV route planning apps for 2026. ABRP, PlugShare, built-in navigation, and the optimal three-app combo.", category: "Technology", image: "/images/blog/ev-route-planning-apps.png", date: "April 27, 2026", readTime: "12 min read", slug: "best-ev-route-planning-apps-2026" },
    { id: 396, title: "EV Prices Are Stabilizing — What That Means for Buyers", excerpt: "After years of volatility, EV prices are stabilizing. Here's what's driving the shift and what it means for buyers.", category: "Trends", image: "/images/blog/ev-prices-stabilizing.png", date: "April 27, 2026", readTime: "12 min read", slug: "ev-prices-stabilizing-2026" },
    { id: 395, title: "Best AWD EVs for Snow and Winter 2026", excerpt: "The best AWD electric vehicles for snow and winter driving — ranked for cold-weather capability.", category: "Guides", image: "/images/blog/awd-evs-winter.png", date: "April 27, 2026", readTime: "13 min read", slug: "best-awd-evs-winter-2026" },
    { id: 394, title: "The EV Lease Return Surge — Why 2026 Is the Best Year to Buy Used", excerpt: "Hundreds of thousands of off-lease EVs are flooding dealer lots in 2026. A once-in-a-decade buying opportunity.", category: "Guides", image: "/images/blog/ev-lease-return-surge.png", date: "April 27, 2026", readTime: "13 min read", slug: "ev-lease-return-surge-2026" },
    { id: 393, title: "What Happens If Your EV Runs Out of Battery?", excerpt: "What actually happens when an EV runs out of battery. Roadside assistance, mobile charging, towing risks.", category: "Technology", image: "/images/blog/ev-runs-out-battery.png", date: "April 27, 2026", readTime: "11 min read", slug: "ev-runs-out-of-battery" },
    { id: 392, title: "Can You Flat Tow an EV?", excerpt: "Can you flat tow an EV behind a motorhome? The honest answer for every major model.", category: "Technology", image: "/images/blog/flat-tow-ev.png", date: "April 27, 2026", readTime: "11 min read", slug: "can-you-flat-tow-ev" },
    { id: 391, title: "Your First Week with an EV", excerpt: "What to do, what to expect, and what to skip during your first week as an EV owner.", category: "Guides", image: "/images/blog/first-week-ev.png", date: "April 27, 2026", readTime: "12 min read", slug: "first-week-with-ev-2026" },
    { id: 390, title: "Five-Minute EV Charging — How Close Are We?", excerpt: "BYD demonstrated 600 kW charging that adds 250 miles in 5 minutes. The reality of ultra-fast EV charging in 2026.", category: "Technology", image: "/images/blog/five-minute-charging.png", date: "April 27, 2026", readTime: "12 min read", slug: "five-minute-ev-charging-2026" },
    { id: 389, title: "Best Time of Year to Buy an EV in 2026", excerpt: "The best months to buy an EV in 2026. Tax-credit timing, end-of-quarter incentives, and stacking discounts.", category: "Guides", image: "/images/blog/best-time-buy-ev.png", date: "April 27, 2026", readTime: "12 min read", slug: "best-time-buy-ev-2026" },
    { id: 388, title: "Why Smaller EV Batteries Might Be Better for Most Drivers", excerpt: "Average EV: 290 miles range. Average driver: 37. Here's why smaller batteries are better for most people.", category: "Technology", image: "/images/blog/smaller-ev-batteries.png", date: "April 27, 2026", readTime: "13 min read", slug: "smaller-ev-batteries-2026" },
    // April 21, 2026 — Articles 38-47 (10 guides/tech/comparison articles)
    { id: 387, title: "Best EVs for First-Time Buyers 2026", excerpt: "The best electric vehicles for first-time EV buyers. Budget tiers, onboarding tips, and honest answers to the questions every new EV owner asks.", category: "Guides", image: "/images/blog/best-evs-first-time-buyers.png", date: "April 21, 2026", readTime: "14 min read", slug: "best-evs-first-time-buyers-guide" },
    { id: 386, title: "EV Maintenance Costs vs Gas Cars — 5-Year Breakdown", excerpt: "Exactly how much you'll save on maintenance over 5 years of EV ownership vs a comparable gas car.", category: "Comparison", image: "/images/blog/ev-maintenance-costs.png", date: "April 21, 2026", readTime: "13 min read", slug: "ev-vs-gas-5-year-maintenance-breakdown" },
    { id: 385, title: "What Happens to EV Batteries When They Die?", excerpt: "The truth about EV battery recycling in 2026. Second-life applications, Redwood Materials, and why EV batteries aren't the landfill problem critics claim.", category: "Technology", image: "/images/blog/ev-battery-recycling.png", date: "April 21, 2026", readTime: "12 min read", slug: "ev-battery-recycling-2026" },
    { id: 384, title: "Best Electric SUVs for Families 2026", excerpt: "The best electric SUVs for families — Kia EV9, Equinox EV, Tesla Model Y, VW ID.Buzz, and Rivian R1S compared.", category: "Guides", image: "/images/blog/best-electric-suvs-families.png", date: "April 21, 2026", readTime: "15 min read", slug: "best-electric-family-suvs-2026" },
    { id: 383, title: "How Much Does It Really Cost to Charge an EV?", excerpt: "The real cost of charging an EV in 2026. Home vs public, per-mile costs, and how to cut your charging bill in half.", category: "Technology", image: "/images/blog/ev-charging-costs.png", date: "April 21, 2026", readTime: "12 min read", slug: "ev-charging-costs-explained" },
    { id: 382, title: "EV vs Hybrid vs Gas in 2026 — Which Is Right for You?", excerpt: "EV vs hybrid vs gas — a complete comparison across upfront cost, running cost, convenience, and real-world ownership.", category: "Comparison", image: "/images/blog/ev-vs-hybrid-vs-gas.png", date: "April 21, 2026", readTime: "14 min read", slug: "ev-vs-hybrid-vs-gas-2026" },
    { id: 381, title: "Best EVs for Florida Drivers 2026", excerpt: "The best electric vehicles for Florida drivers in 2026. How heat, humidity, hurricanes, and highway driving affect EV choice.", category: "Guides", image: "/images/blog/best-evs-florida.png", date: "April 21, 2026", readTime: "13 min read", slug: "best-evs-florida-drivers-2026" },
    { id: 380, title: "Home EV Charging Explained — Level 1 vs Level 2", excerpt: "Level 1 vs Level 2 home EV charging in 2026. Installation costs, speed, best chargers, and whether you need the 240V upgrade.", category: "Technology", image: "/images/blog/home-ev-charging.png", date: "April 21, 2026", readTime: "12 min read", slug: "home-ev-charging-level-1-vs-level-2" },
    { id: 379, title: "EV Road Trip Planning 101", excerpt: "How to plan your first EV road trip. Route planning apps, charging strategy, and lessons learned from thousands of EV road-trippers.", category: "Guides", image: "/images/blog/ev-road-trip-planning.png", date: "April 21, 2026", readTime: "13 min read", slug: "ev-road-trip-planning-101" },
    { id: 378, title: "Should You Buy a Used EV in 2026? Complete Buyer's Guide", excerpt: "The used EV market in 2026 is the best it's ever been. Battery health, warranty checks, pricing, and what to watch for before you buy.", category: "Guides", image: "/images/blog/used-ev-buyers-guide.png", date: "April 21, 2026", readTime: "14 min read", slug: "used-ev-buyers-guide-2026" },
    ...
    { id: 372, title: "Chevy Equinox EV at 20% Off — Best Affordable EV Deal?", excerpt: "The Chevy Equinox EV is now available at 20% off MSRP. At under $28,000 after incentives, is this the best affordable EV deal?", category: "Reviews", image: "/images/blog/equinox-ev-deal-hero.png", date: "April 12, 2026", readTime: "11 min read", slug: "equinox-ev-deal" },
    { id: 371, title: "The Best EV Deals in April 2026", excerpt: "The best EV deals available right now — manufacturer incentives, dealer discounts, and expiring lease deals.", category: "Guides", image: "/images/blog/best-ev-deals-april-hero.png", date: "April 12, 2026", readTime: "15 min read", slug: "best-ev-deals-april" },
    { id: 370, title: "Mercedes CLA 250+ Electric: 370 Miles Under $50,000", excerpt: "Mercedes just revealed the CLA 250+ Electric with 370 miles of range and a starting price under $50,000.", category: "News", image: "/images/blog/mercedes-cla-electric-hero.png", date: "April 12, 2026", readTime: "12 min read", slug: "mercedes-cla-electric" },
    { id: 369, title: "Rivian R2 Gets Its EPA Range Rating", excerpt: "The Rivian R2 just received its official EPA range rating. Here's how it compares to competitors.", category: "News", image: "/images/blog/rivian-r2-epa-hero.png", date: "April 12, 2026", readTime: "11 min read", slug: "rivian-r2-epa" },
    { id: 368, title: "Strait of Hormuz Blockade: What $6 Gas Would Mean for EV Demand", excerpt: "Tensions in the Strait of Hormuz could push gas prices to $6/gallon. Here's how that would accelerate EV adoption.", category: "Insights", image: "/images/blog/hormuz-gas-prices-hero.png", date: "April 12, 2026", readTime: "14 min read", slug: "hormuz-gas-prices" },
    { id: 367, title: "EV Prices Are Now the Closest They've Ever Been to Gas Cars", excerpt: "The average EV price has dropped to within striking distance of gas car prices.", category: "Insights", image: "/images/blog/ev-prices-parity-hero.png", date: "April 12, 2026", readTime: "13 min read", slug: "ev-prices-parity" },
    { id: 366, title: "Every EV That Got Canceled or Delayed in 2026", excerpt: "From the Afeela to the Apple Car, several high-profile EVs have been canceled or pushed back in 2026.", category: "News", image: "/images/blog/canceled-evs-2026-hero.png", date: "April 12, 2026", readTime: "14 min read", slug: "canceled-evs-2026" },
    { id: 365, title: "Tesla Full Self-Driving Just Got Approved in Europe", excerpt: "Tesla's FSD system has been approved for use in Europe — a major milestone for autonomous driving.", category: "Technology", image: "/images/blog/tesla-fsd-europe-hero.png", date: "April 12, 2026", readTime: "12 min read", slug: "tesla-fsd-europe" },
    ...
    { id: 361, title: "The Slate Truck: A $25,000 Electric Pickup Backed by Jeff Bezos — Is This the EV America's Been Waiting For?", excerpt: "The Slate Truck is a customizable electric pickup starting around $25,000 with 150,000+ reservations and Tesla Supercharger access.", category: "News", image: "/images/blog/slate-truck-hero.png", date: "April 7, 2026", readTime: "13 min read", slug: "slate-truck-cheapest-ev-pickup" },
    { id: 360, title: "Mercedes Steer-by-Wire Is Coming in 2026 — Why This Invisible Technology Changes How Every EV Drives", excerpt: "Mercedes-Benz is bringing steer-by-wire to the facelifted EQS — the first German automaker to ditch the mechanical steering column.", category: "Technology", image: "/images/blog/mercedes-steer-by-wire-hero.png", date: "April 7, 2026", readTime: "12 min read", slug: "mercedes-steer-by-wire-2026" },
    { id: 359, title: "Solid-State Batteries Are Finally Real — Toyota and Sumitomo Just Proved It", excerpt: "Toyota and Sumitomo just announced a joint agreement to build solid-state batteries for EVs. Double range, 10-minute charging, 20-year lifespan.", category: "Technology", image: "/images/blog/solid-state-battery-hero.png", date: "April 7, 2026", readTime: "14 min read", slug: "solid-state-batteries-toyota-2026" },
    // April 7, 2026 — News, Technology (Articles 14-18)
    { id: 358, title: "EVs Sweep Every 2026 World Car Award — Here's What Won and Why It Matters", excerpt: "Electric vehicles won every category at the 2026 World Car Awards — a first in 22 years. BMW iX3, Lucid Gravity, Hyundai IONIQ 6 N, and more.", category: "News", image: "/images/blog/evs-sweep-world-car-awards-hero.png", date: "April 7, 2026", readTime: "14 min read", slug: "evs-sweep-2026-world-car-awards" },
    { id: 357, title: "Toyota bZ Is Now America's Best-Selling Non-Tesla EV — How the Slowest Starter Won the Race", excerpt: "The Toyota bZ sold 10,029 units in Q1 2026 — up 79% — making it America's top-selling non-Tesla EV.", category: "News", image: "/images/blog/toyota-bz-best-selling-ev-hero.png", date: "April 7, 2026", readTime: "13 min read", slug: "toyota-bz-best-selling-non-tesla-ev" },
    { id: 356, title: "Subaru Goes All-In on Electric — Two New EVs That Could Win Over the Brand's Most Loyal Fans", excerpt: "Subaru launches the 3-row Trailseeker and sporty Uncharted crossover — both with AWD, 300+ miles of range.", category: "News", image: "/images/blog/subaru-trailseeker-uncharted-hero.png", date: "April 7, 2026", readTime: "13 min read", slug: "subaru-trailseeker-uncharted-ev-launch" },
    { id: 355, title: "Vehicle-to-Grid: Your EV Could Power Your Home During a Hurricane — Here's How", excerpt: "V2G technology lets your EV power your home for days during outages. Which cars support it and why Florida homeowners should pay attention.", category: "Technology", image: "/images/blog/vehicle-to-grid-ev-power-home-hero.png", date: "April 7, 2026", readTime: "14 min read", slug: "vehicle-to-grid-ev-power-home" },
    { id: 354, title: "Tesla Roadster Is Finally Coming — Everything We Know About the April 2026 Unveil", excerpt: "Elon Musk confirms the Tesla Roadster unveil is happening in April 2026. Specs, pricing, and when you can buy one.", category: "News", image: "/images/blog/tesla-roadster-2026-hero.png", date: "April 7, 2026", readTime: "13 min read", slug: "tesla-roadster-april-2026-unveil" },
    // April 5, 2026 — Guides, Tips, Education, Finance
    { id: 353, title: "Best EVs for Road Trips 2026 — Long Range, Fast Charging, Zero Stress", excerpt: "Best electric vehicles for road trips in 2026. Range, charging speed, comfort — the EVs that make long-distance driving effortless.", category: "EV Buying Guide", image: "/images/blog/best-evs-for-road-trips-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "best-evs-for-road-trips-2026" },
    { id: 352, title: "EV Home Charging Complete Guide 2026 — Level 1, Level 2, and What You Actually Need", excerpt: "Complete guide to EV home charging. Level 1 vs Level 2, installation costs, best chargers, and whether you really need a 240V upgrade.", category: "Guides", image: "/images/blog/ev-charging-at-home-complete-guide-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "ev-charging-at-home-complete-guide-2026" },
    { id: 351, title: "Best Used EVs Under $25,000 in 2026 — Serious Cars, Serious Savings", excerpt: "Best used electric vehicles under $25,000. Tesla Model 3, Chevy Bolt, Hyundai Ioniq 5 — pre-owned EVs with real range at real savings.", category: "EV Buying Guide", image: "/images/blog/best-used-evs-under-25000-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "best-used-evs-under-25000-2026" },
    { id: 350, title: "EV Maintenance Costs vs Gas Cars 2026 — The Real Numbers", excerpt: "Real EV maintenance costs compared to gas cars. Oil changes, brakes, tires, battery — what you actually spend.", category: "EV Ownership", image: "/images/blog/ev-maintenance-costs-vs-gas-cars-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "ev-maintenance-costs-vs-gas-cars-2026" },
    { id: 349, title: "EV Winter Driving Tips 2026 — Range Loss, Preconditioning, and Cold Weather Survival", excerpt: "How to drive an EV in winter. Managing range loss, preconditioning, and cold weather charging tips.", category: "EV Tips", image: "/images/blog/ev-winter-driving-tips-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "ev-winter-driving-tips-2026" },
    { id: 348, title: "Tesla vs Hyundai vs Chevy — Which EV Brand to Choose in 2026", excerpt: "Tesla Model Y vs Hyundai Ioniq 5 vs Chevy Equinox EV. Price, range, charging — which mainstream EV brand wins.", category: "Comparison", image: "/images/blog/tesla-vs-hyundai-vs-chevy-ev-comparison-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "tesla-vs-hyundai-vs-chevy-ev-comparison-2026" },
    { id: 347, title: "How EV Tax Credits Work in 2026 — What Changed and What's Available", excerpt: "Complete guide to EV tax credits and incentives in 2026. Federal changes, state programs, and how to maximize savings.", category: "Insights", image: "/images/blog/how-ev-tax-credits-work-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "how-ev-tax-credits-work-2026" },
    { id: 346, title: "10 EV Myths Debunked in 2026 — What's Actually True About Electric Cars", excerpt: "The biggest EV myths debunked with 2026 data. Range anxiety, battery fires, charging time, grid impact — fact vs fiction.", category: "Guides", image: "/images/blog/ev-myths-debunked-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "ev-myths-debunked-2026" },
    { id: 345, title: "EV Road Trip Planning Guide 2026 — Step by Step", excerpt: "How to plan an EV road trip. Route planning apps, charging strategy, and pre-trip checklist.", category: "Guides", image: "/images/blog/ev-road-trip-planning-guide-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "ev-road-trip-planning-guide-2026" },
    { id: 344, title: "Cheapest EVs to Own in 2026 — Total Cost Including Fuel, Insurance, and Maintenance", excerpt: "The cheapest EVs to own when you factor in purchase price, electricity, insurance, maintenance, and depreciation.", category: "Insights", image: "/images/blog/cheapest-evs-to-own-2026.png", date: "April 5, 2026", readTime: "12 min read", slug: "cheapest-evs-to-own-2026" },
    ...
    // News Articles — April 2026 (Batch 2: Articles 6-10)
    {
      ...
      excerpt: "Over 30 new electric vehicles are launching in the US in 2026. Here's every model confirmed — specs, pricing, and when you can buy them.",
      category: "News",
      image: "/images/blog/every-new-ev-2026-hero.png",
      date: "April 3, 2026",
      readTime: "16 min read",
      slug: "every-new-ev-2026-tracker",
    },
    {
      id: 339,
      title: "Honda and Sony Officially Kill the Afeela EV — What Went Wrong and What's Next",
      excerpt: "Sony Honda Mobility has canceled the Afeela 1 electric car. Here's why the project failed and what Honda is doing instead.",
      category: "News",
      image: "/images/blog/afeela-canceled-hero.png",
      date: "April 3, 2026",
      readTime: "10 min read",
      slug: "honda-sony-afeela-canceled",
    },
    {
      id: 338,
      title: "Rivian R2 Wins 2026 Electric Green Car of the Year — and Robotaxis Are Coming to Miami",
      excerpt: "The Rivian R2 just won Electric Green Car of the Year. Plus, Rivian's robotaxi service is coming to Miami in 2028.",
      category: "News",
      image: "/images/blog/rivian-r2-coastal-hero.png",
      date: "April 3, 2026",
      readTime: "11 min read",
      slug: "rivian-r2-green-car-of-the-year",
    },
    {
      id: 337,
      title: "BYD Eyes 1.5 Million Exports in 2026 as Oil Shock Supercharges Global EV Demand",
      excerpt: "BYD is targeting 1.5 million overseas EV sales in 2026. Here's what the Chinese EV giant's expansion means for American car buyers.",
      category: "News",
      image: "/images/blog/byd-exports-port-hero.png",
      date: "April 3, 2026",
      readTime: "11 min read",
      slug: "byd-exports-2026",
    },
    {
      id: 336,
      title: "Gas Prices Are Surging in 2026 — Here's Exactly How Much You'd Save by Going Electric",
      excerpt: "Gas prices are climbing past $4/gallon. We ran the real numbers on switching to an EV — fuel, maintenance, and total cost compared.",
      category: "Insights",
      image: "/images/blog/gas-prices-ev-savings-hero.png",
      date: "April 3, 2026",
      readTime: "13 min read",
      slug: "gas-prices-ev-savings-2026",
    },
