      ...
      <article className="pt-32 pb-20 px-6">
        <div className="max-w-[800px] mx-auto">
          ...
          <h1 className="text-[42px] md:text-[52px] font-bold leading-[1.1] mb-6">
            Understanding EV Tax Credits in
            <span className="text-[#4a90d9]"> 2026: Complete Guide</span>
          </h1>
          ...
          <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden mb-12">
            <img
              src="/blog/ev-tax-credits-2026.png"
              alt="EV tax credits 2026 guide"
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <div className="flex flex-wrap gap-2 mt-12 pt-8 border-t border-[rgba(74,144,217,0.2)]">
              <span className="px-3 py-1 bg-[rgba(74,144,217,0.1)] text-[#4a90d9] text-[13px] rounded-full">EV Tax Credit</span>
              <span className="px-3 py-1 bg-[rgba(74,144,217,0.1)] text-[#4a90d9] text-[13px] rounded-full">Federal Incentives</span>
              <span className="px-3 py-1 bg-[rgba(74,144,217,0.1)] text-[#4a90d9] text-[13px] rounded-full">2026 Guide</span>
              <span className="px-3 py-1 bg-[rgba(74,144,217,0.1)] text-[#4a90d9] text-[13px] rounded-full">Electric Vehicle</span>
              <span className="px-3 py-1 bg-[rgba(74,144,217,0.1)] text-[#4a90d9] text-[13px] rounded-full">IRA</span>
            </div>
          </div>
        </div>
      </article>
