      ...
      <section className="relative pt-32 pb-16 px-4">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden mb-12">
            <Image src="/images/blog/first-ev-buyers-guide.png" alt="Complete first-time electric vehicle buyer's guide" fill className="object-cover" priority />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-t border-slate-700/50 pt-8 mt-12">
            <div className="flex flex-wrap gap-3 mb-8">
              <Link href="/blog?tag=first-ev" className="px-4 py-2 bg-slate-800/50 rounded-full text-sm text-slate-400 border border-slate-700/50 hover:border-emerald-500/30 hover:text-emerald-400 transition-colors">First EV</Link>
              <Link href="/blog?tag=buyer-apos-s-guide" className="px-4 py-2 bg-slate-800/50 rounded-full text-sm text-slate-400 border border-slate-700/50 hover:border-emerald-500/30 hover:text-emerald-400 transition-colors">Buyer&apos;s Guide</Link>
              <Link href="/blog?tag=beginners" className="px-4 py-2 bg-slate-800/50 rounded-full text-sm text-slate-400 border border-slate-700/50 hover:border-emerald-500/30 hover:text-emerald-400 transition-colors">Beginners</Link>
              <Link href="/blog?tag=electric-cars" className="px-4 py-2 bg-slate-800/50 rounded-full text-sm text-slate-400 border border-slate-700/50 hover:border-emerald-500/30 hover:text-emerald-400 transition-colors">Electric Cars</Link>
