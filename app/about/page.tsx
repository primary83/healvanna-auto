...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 px-6 md:px-12 max-w-[900px] mx-auto">
      ...
      <section className="px-6 md:px-12 py-16 bg-[#0d1220]">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="text-center p-10 border border-[rgba(74,144,217,0.3)] bg-[rgba(74,144,217,0.05)] rounded-sm">
            <p className="text-xl text-[#e8edf5] font-light italic mb-4">
              &ldquo;HEALVANNA — Your Car&apos;s Wellness Guide&rdquo;
            </p>
