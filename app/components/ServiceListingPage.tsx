...
function ServiceListingContent({ service, subcategorySlug }: ServiceListingPageProps) {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      ...
      try {
        ...
        console.error("[ServiceListingPage] Provider fetch error:", err);
  ...
  }, [providers, sortBy, centerLat, centerLon, activeFilters]);
            ...
            <div className="text-center py-12">
              ...
              <p className="text-[#6b7a94] mb-2">
                {activeFilters.length > 0
                  ...
                  : "No providers found in this area. Try a different location or search term."}
              </p>
              {activeFilters.length > 0 && (
