...
export default function EliteCeramicWorks() {
  ...
  const handleQuoteSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xjggywyr", {
        ...
        body: JSON.stringify({
          ...quoteForm,
          source: "Elite Ceramic Works - Quote Request",
        }),
      });
  ...
  const services = [
    { name: "Ceramic Pro Silver", description: "Entry-level ceramic coating with 2 years of protection. Single layer application with hydrophobic properties.", price: "From $799" },
    { name: "Ceramic Pro Gold", description: "Mid-tier protection with 4 layers and 5-year warranty. Includes paint correction and annual inspection.", price: "From $1,500" },
    { name: "Ceramic Pro Platinum", description: "Ultimate protection with lifetime warranty. Multiple layers on all surfaces including wheels and glass.", price: "From $2,500" },
    { name: "XPEL Ultimate Plus PPF", description: "Premium paint protection film with self-healing technology. Full front-end or complete vehicle coverage.", price: "From $1,800" },
    { name: "Gtechniq Crystal Serum", description: "Ultra-durable ceramic coating rated 9H hardness. Professional-only product with 9-year guarantee.", price: "From $1,800" },
    { name: "Wheel & Caliper Coating", description: "Heat-resistant ceramic coating for wheels and brake calipers. Easier cleaning and enhanced appearance.", price: "From $400" },
  ];

  const certifications = [
    "Ceramic Pro Certified Installer",
    "XPEL Platinum Installer",
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0d1424] border border-[rgba(74,144,217,0.2)] rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-[rgba(74,144,217,0.1)]">
              ...
              <p className="text-sm text-[#6b7a94] mt-1">Elite Ceramic Works • Miami, FL</p>
            </div>
            ...
            {quoteStatus === "success" ? (
              <div className="p-8 text-center">
                ...
                <p className="text-[#6b7a94] text-sm mb-6">Elite Ceramic Works will contact you within 24 hours with a custom quote.</p>
      ...
      <section className="pt-32 pb-16 px-12 bg-gradient-to-b from-[#0d1424] to-[#0a0f1a]">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94] mb-8">
            ...
            <span className="text-[#e8edf5]">Elite Ceramic Works</span>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="px-3 py-1 bg-[rgba(34,197,94,0.15)] text-[#22c55e] text-xs tracking-wider uppercase rounded-full font-medium">✓ In Business</span>
                <span className="px-3 py-1 bg-[rgba(74,144,217,0.15)] text-[#4a90d9] text-xs tracking-wider uppercase rounded-full">Ceramic & PPF</span>
              </div>
              <h1 className="text-[clamp(36px,5vw,52px)] font-extralight tracking-tight mb-2 leading-tight">Elite Ceramic Works</h1>
              <p className="text-xl text-[#4a90d9] mb-4">Miami, FL</p>
              <p className="text-[17px] text-[#6b7a94] leading-relaxed mb-8 max-w-[500px]">Certified Ceramic Pro installer specializing in exotic and luxury vehicle protection. Over 15 years of experience with Ferrari, Lamborghini, Porsche, and high-end EVs.</p>

              <div className="flex flex-wrap gap-2 mb-8">
                {["XPEL PPF", "Ceramic Pro", "Gtechniq", "Exotic Cars"].map((tag) => (
              ...
              <div className="flex gap-4">
                ...
                <a href="tel:+13055559876" className="px-8 py-3 text-[13px] font-medium bg-transparent border border-[rgba(74,144,217,0.3)] text-[#4a90d9] hover:bg-[rgba(74,144,217,0.1)] transition-all duration-300 rounded">Call Now</a>
              </div>
            </div>

            <div className="relative">
              <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80" alt="Elite Ceramic Works" className="w-full h-80 object-cover rounded-lg shadow-2xl" />
              <div className="absolute bottom-4 left-4 right-4 bg-[rgba(10,15,26,0.9)] backdrop-blur-sm rounded-lg p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="text-[#e8edf5]">Mon-Fri: 9AM - 6PM</div>
                  </div>
      ...
      <section className="py-20 px-12 bg-[#0d1424]">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[clamp(24px,4vw,36px)] font-extralight mb-4">Ready to Protect Your Investment?</h2>
          <p className="text-[15px] text-[#6b7a94] mb-8">Contact Elite Ceramic Works for a consultation and custom quote for your exotic or luxury vehicle.</p>
          <div className="flex gap-4 justify-center">
            <button onClick={() => setShowQuoteModal(true)} className="px-8 py-3 text-[13px] font-medium bg-[#4a90d9] text-[#0a0f1a] hover:bg-[#6ba8eb] transition-all duration-300 rounded">Request a Quote</button>
            <a href="tel:+13055559876" className="px-8 py-3 text-[13px] font-medium bg-transparent border border-[rgba(74,144,217,0.3)] text-[#4a90d9] hover:bg-[rgba(74,144,217,0.1)] transition-all duration-300 rounded">Call (305) 555-9876</a>
          </div>
        </div>
      </section>
