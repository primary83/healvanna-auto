...
export async function generateMetadata({
  ...
  const title = `Best ${service.name} in ${city.city}, ${city.stateCode} - Top Car Wash Services`;
  const description = `Find the best ${service.name.toLowerCase()} services in ${city.city}, ${city.stateCode}. Compare hand wash, touchless, and full-service car wash locations.`;
...
export default async function CarWashingLocationPage({
  params,
}: {
  params: Promise<{ location: string }>;
}) {
