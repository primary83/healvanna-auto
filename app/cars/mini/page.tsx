    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-8 px-6 md:px-12 border-b border-[#1a2235]">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-8">
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">2</span>
            <p className="text-sm text-[#6b7a94] mt-1">Models Available</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">245 mi</span>
            <p className="text-sm text-[#6b7a94] mt-1">Max Range</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">5.6s</span>
            <p className="text-sm text-[#6b7a94] mt-1">Fastest 0-60</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">Go-Kart</span>
            <p className="text-sm text-[#6b7a94] mt-1">Driving Feel</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="w-32 h-24 bg-gradient-to-br from-green-900/20 to-[#0d1420] rounded-xl flex items-center justify-center border border-[#1a2235]">
              <span className="text-[#467035] font-bold text-lg tracking-wide">MINI</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-light text-[#e8edf5]">Mini</h1>
              <p className="text-[#6b7a94] mt-1">Big Love. Zero Emissions.</p>
            </div>
          </div>

          <p className="text-[#8a919e] max-w-3xl leading-relaxed">
            Mini brings its legendary fun-to-drive character to the electric era. From the
            nimble Cooper SE to the versatile Countryman SE, Mini proves that going electric
            doesn&apos;t mean giving up the joy of driving.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-light text-[#e8edf5] mb-8">All Mini EV Models</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {models.map((model) => (
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-green-900/20 to-[#0d1420] overflow-hidden">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-gradient-to-r from-green-900/40 to-green-800/30 text-[#467035] text-[10px] font-bold px-3 py-1 rounded border border-green-700/20">
                      MINI
                    </span>
                  </div>
