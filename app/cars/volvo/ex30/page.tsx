...
export default function VolvoEX30Page() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <MaintenanceSchedule brand="Volvo" model="EX30" theme="sapphire" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <Link href="/cars/mini/cooper-se" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Mini Cooper SE</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
              <Link href="/cars/audi/q4-e-tron" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Audi Q4 e-tron</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
          ...
          <div className="mt-4">
            <Link href="/cars/volvo" className="text-sm text-emerald-400 hover:text-emerald-300 transition-colors">
              ← All Volvo Models
            </Link>
          </div>
        </div>
