...
export default function VolvoEX90Page() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <section className="px-12 py-12">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl font-light tracking-tight mb-4">EX90</h1>
            <p className="text-xl text-[#8a9bb5] mb-6">Our flagship electric SUV. Three rows of sustainable luxury with the most advanced safety technology we've ever created.</p>
            <div className="text-3xl font-light text-[#1c6bba] mb-8">$76,695 <span className="text-base text-[#6b7a94]">Starting MSRP</span></div>
            
            <div className="grid grid-cols-4 gap-6 mb-8">
              <div className="bg-[#0d1424] rounded-xl p-4 text-center">
                <div className="text-2xl font-light text-[#1c6bba]">310 mi</div>
                <div className="text-xs text-[#6b7a94]">EPA Range</div>
              </div>
              <div className="bg-[#0d1424] rounded-xl p-4 text-center">
                <div className="text-2xl font-light text-[#1c6bba]">4.7s</div>
              ...
              <div className="bg-[#0d1424] rounded-xl p-4 text-center">
                <div className="text-2xl font-light text-[#1c6bba]">7</div>
                <div className="text-xs text-[#6b7a94]">Seats</div>
              </div>
            </div>
          </div>
      ...
      <section className="px-12 py-16 bg-[#0d1424]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "LiDAR Safety", desc: "Standard LiDAR technology for unmatched sensing and safety capabilities." },
              { title: "Three-Row Seating", desc: "Spacious seven-seat configuration with premium comfort in all rows." },
              { title: "111 kWh Battery", desc: "Largest battery in the Volvo lineup for maximum range and capability." },
              { title: "Bi-Directional Charging", desc: "Power your home or other devices with vehicle-to-load capability." },
              { title: "Bowers & Wilkins", desc: "Reference-grade audio system with Dolby Atmos for concert-hall sound." },
              { title: "Air Suspension", desc: "Dual-chamber air suspension for the ultimate in ride comfort." },
            ].map((feature, i) => (
      ...
      <ChargingSection brand="Volvo" model="EX90" slug="volvo/ex90" range={310} theme="sapphire" />
      <MaintenanceSchedule brand="Volvo" model="EX90" theme="sapphire" />
