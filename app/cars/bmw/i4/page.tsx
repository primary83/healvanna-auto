...
export default function BMWi4() {
  ...
  return (
    <main className="min-h-screen bg-slate-950">
      ...
      <ChargingSection brand="BMW" model="i4" slug="bmw/i4" range={301} theme="slate" />
      <MaintenanceSchedule brand="BMW" model="i4" theme="slate" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Link href="/cars/mercedes/eqe" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Mercedes EQE</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
          </div>
          <div className="mt-4">
            <Link href="/cars/bmw" className="text-sm text-emerald-400 hover:text-emerald-300 transition-colors">
              ← All Bmw Models
            </Link>
          </div>
        </div>
