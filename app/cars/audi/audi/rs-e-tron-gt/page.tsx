...
export default function RSETronGTPage() {
  ...
  const features = [
    "RS-tuned sport suspension",
    "Carbon ceramic brakes available",
    "RS sport exhaust sound",
    "Alcantara/leather RS interior",
    "Three-chamber adaptive air suspension",
    "RS-specific drive select modes",
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <Image
          src="/cars/audi/rs-e-tron-gt.png"
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto">
              The Ultimate Electric RS
            </p>
            <p className="text-3xl font-bold text-white mt-6">Starting at $147,000</p>
          </motion.div>
        </div>
      </section>
