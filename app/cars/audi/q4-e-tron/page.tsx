...
export default function Q4ETronPage() {
  ...
  const variants = [
    { name: "Q4 40 e-tron", price: "$49,800", range: "265 mi", power: "295 hp" },
    { name: "Q4 50 e-tron quattro", price: "$56,200", range: "241 mi", power: "295 hp" },
    { name: "Q4 Sportback 50", price: "$58,200", range: "245 mi", power: "295 hp" },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <section className="pt-24 pb-4 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Q4 e-tron</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-light mb-4">Audi Q4 e-tron</h1>
              <p className="text-xl text-[#4a90d9] mb-2">2024 • From $49,800</p>
              <p className="text-[#6b7a94] mb-8 max-w-lg">The accessible luxury electric SUV with quattro confidence, spacious interior, and premium Audi craftsmanship.</p>
            ...
            <div className="relative h-[400px] bg-gradient-to-br from-[#12182a] to-[#0d1220] rounded-2xl flex items-center justify-center">
              <Image src="/cars/audi/q4-e-tron.png" alt="Audi Q4 e-tron" width={500} height={300} className="object-contain" />
            </div>
          </div>
        </div>
      </section>
      ...
      <MaintenanceSchedule brand="Audi" model="Q4 e-tron" theme="sapphire" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Link href="/cars/volvo/ex30" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Volvo EX30</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
          </div>
          <div className="mt-4">
