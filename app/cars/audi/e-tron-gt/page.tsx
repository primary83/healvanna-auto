...
export default function ETronGTPage() {
  ...
  const variants = [
    { name: "e-tron GT", price: "$106,500", range: "238 mi", power: "522 hp" },
    { name: "e-tron GT Performance", price: "$114,500", range: "238 mi", power: "590 hp" },
  ];
      ...
      <section className="pt-24 pb-4 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">e-tron GT</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-light mb-4">Audi e-tron GT</h1>
              <p className="text-xl text-[#4a90d9] mb-2">2024 • From $106,500</p>
              <p className="text-[#6b7a94] mb-8 max-w-lg">The stunning electric grand tourer with breathtaking design and exhilarating performance.</p>
            ...
            <div className="relative h-[400px] bg-gradient-to-br from-[#12182a] to-[#0d1220] rounded-2xl flex items-center justify-center">
              <Image src="/cars/audi/e-tron-gt.png" alt="Audi e-tron GT" width={500} height={300} className="object-contain" />
            </div>
          </div>
        </div>
      </section>
