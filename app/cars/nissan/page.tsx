...
export default function NissanBrand() {
  const models = [
    {
      name: "Ariya",
      slug: "ariya",
      image: "/cars/nissan/ariya.png",
      startingPrice: "$41,160",
      range: "304 miles",
      acceleration: "5.0s 0-60",
      topSpeed: "130 mph",
      description: "A bold, premium electric crossover with a lounge-like interior and advanced e-4ORCE all-wheel drive technology."
    },
    {
      name: "LEAF",
      slug: "leaf",
      image: "/cars/nissan/leaf.png",
      startingPrice: "$29,280",
      range: "212 miles",
      acceleration: "7.4s 0-60",
      topSpeed: "98 mph",
      description: "The pioneering electric car that started it all. Affordable, practical, and perfect for daily commuting."
    },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center p-3">
              <span className="text-[#C3002F] font-bold text-2xl tracking-tight">NISSAN</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">Nissan</h1>
              <p className="text-slate-400">Electric Vehicles &bull; Founded 1933 &bull; Yokohama, Japan</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">304 mi</div>
              <div className="text-sm text-slate-400">Max Range</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">5.0s</div>
              <div className="text-sm text-slate-400">Fastest 0-60</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">e-4ORCE</div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-bold text-white mb-8">All Nissan Models</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {models.map((model) => (
              <Link
                key={model.slug}
                href={`/cars/nissan/${model.slug}`}
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden">
                  <Image src={model.image} alt={`Nissan ${model.name}`} fill className="object-cover" />
                  <div className="absolute top-3 right-3 px-3 py-1 bg-red-600 text-white text-xs font-semibold rounded-full">Nissan</div>
                </div>

                <div className="p-5">
                  <h3 className="text-xl font-bold text-white mb-2 group-hover:text-emerald-400 transition-colors">Nissan {model.name}</h3>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-red-900/20 to-slate-800/50 rounded-3xl p-8 md:p-12 border border-red-500/20">
            <h2 className="text-2xl font-bold text-white mb-6">Why Choose Nissan?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <h3 className="text-lg font-semibold text-white mb-2">EV Pioneer</h3>
                <p className="text-slate-400 text-sm">Over a decade of EV manufacturing experience, with millions of electric miles driven worldwide.</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">e-4ORCE AWD</h3>
                <p className="text-slate-400 text-sm">Advanced twin-motor all-wheel drive system delivers precise control in all conditions.</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">ProPILOT Assist</h3>
                <p className="text-slate-400 text-sm">Hands-on driver assistance with lane centering, adaptive cruise, and traffic jam pilot.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-3xl p-8 md:p-12 border border-emerald-500/20">
            <div className="max-w-2xl">
              <h2 className="text-2xl font-bold text-white mb-4">Own a Nissan? Protect Your Investment</h2>
              <p className="text-slate-300 mb-6">Our premium ceramic coating and PPF services keep your Nissan looking showroom-new for years.</p>
      ...
      <BrandHubSections brandSlug="nissan" />
