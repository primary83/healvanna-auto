...
export default function RivianBrand() {
  ...
  return (
    <main className="min-h-screen bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-10 border border-slate-700">
            <h2 className="text-3xl font-bold text-white mb-4">
              Own a Rivian? Protect Your Investment
            </h2>
            <p className="text-slate-300 text-lg mb-8 max-w-2xl">
              Our premium ceramic coating and PPF services keep your Rivian looking showroom-new for years.
            </p>
      ...
      <BrandHubSections brandSlug="rivian" />
