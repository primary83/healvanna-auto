...
export default function Polestar3Page() {
  const specs = {
    range: "315 mi",
    acceleration: "4.6s",
    topSpeed: "130 mph",
  ...
  const variants = [
    { name: "Long Range Dual Motor", price: "$73,400", range: "315 mi", power: "489 hp" },
    { name: "Performance Pack", price: "$79,400", range: "295 mi", power: "510 hp" },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-[#4a90d9] text-lg mb-4">2024 • From $73,400</p>
            <p className="text-[#8a919e] mb-8 max-w-lg">
              The SUV for the electric age. Commanding presence meets aerodynamic excellence 
              with advanced technology and sustainable luxury.
            </p>
          ...
          <div className="relative h-[400px] lg:h-[500px]">
            <Image
              src="/cars/polestar/polestar-3.png"
              alt="Polestar 3"
              fill
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#e8edf5]">489 hp</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Torque</span>
                  <span className="text-[#e8edf5]">620 lb-ft</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">0-60 mph</span>
                  <span className="text-[#e8edf5]">4.6 seconds</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Top Speed</span>
                  <span className="text-[#e8edf5]">130 mph</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#e8edf5]">111 kWh</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Range (EPA)</span>
                  <span className="text-[#e8edf5]">315 miles</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">DC Fast Charging</span>
                  <span className="text-[#e8edf5]">250 kW</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#e8edf5]">192.5 in</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Width</span>
                  <span className="text-[#e8edf5]">84.5 in</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Height</span>
                  <span className="text-[#e8edf5]">64.2 in</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Cargo Space</span>
                  <span className="text-[#e8edf5]">17.1 cu ft</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="px-6 md:px-12 py-12 bg-[#0d1420]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              "Google Built-In",
              "Pilot Assist with LiDAR",
              "Air Suspension",
              "Bowers & Wilkins Audio",
              "Panoramic Roof",
              "Rear-Wheel Steering",
              "Animal Welfare Interior",
      ...
      <ChargingSection brand="Polestar" model="3" slug="polestar/polestar-3" range={315} theme="sapphire" />
      <MaintenanceSchedule brand="Polestar" model="3" theme="sapphire" />
