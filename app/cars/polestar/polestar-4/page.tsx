...
export default function Polestar4Page() {
  const specs = {
    range: "300 mi",
    acceleration: "3.8s",
    topSpeed: "124 mph",
  ...
  const variants = [
    { name: "Long Range Single Motor", price: "$56,300", range: "300 mi", power: "272 hp" },
    { name: "Long Range Dual Motor", price: "$64,300", range: "270 mi", power: "544 hp" },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-[#4a90d9] text-lg mb-4">2024 • From $56,300</p>
            <p className="text-[#8a919e] mb-8 max-w-lg">
              The SUV coupé. A bold silhouette that challenges convention with no rear window, 
              replaced by a rear-mounted camera display for unobstructed views.
            </p>
          ...
          <div className="relative h-[400px] lg:h-[500px]">
            <Image
              src="/cars/polestar/polestar-4.png"
              alt="Polestar 4"
              fill
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#e8edf5]">544 hp</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Torque</span>
                  <span className="text-[#e8edf5]">568 lb-ft</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">0-60 mph</span>
                  <span className="text-[#e8edf5]">3.8 seconds</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Top Speed</span>
                  <span className="text-[#e8edf5]">124 mph</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#e8edf5]">102 kWh</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Range (EPA)</span>
                  <span className="text-[#e8edf5]">300 miles</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">DC Fast Charging</span>
                  <span className="text-[#e8edf5]">200 kW</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Charge Time (10-80%)</span>
                  <span className="text-[#e8edf5]">30 min</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#e8edf5]">192.7 in</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Width</span>
                  <span className="text-[#e8edf5]">76.3 in</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Height</span>
                  <span className="text-[#e8edf5]">60.2 in</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6b7a94]">Cargo Space</span>
                  <span className="text-[#e8edf5]">17.7 cu ft</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="px-6 md:px-12 py-12 bg-[#0d1420]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              "No Rear Window Design",
              "Rear-Mounted Camera Display",
              "Google Built-In",
              "Pilot Assist",
              "Air Suspension",
      ...
      <ChargingSection brand="Polestar" model="4" slug="polestar/polestar-4" range={300} theme="sapphire" />
      <MaintenanceSchedule brand="Polestar" model="4" theme="sapphire" />
