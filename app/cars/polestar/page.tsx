...
export default function PolestarPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#111927] to-[#0d1420] rounded-2xl p-10 border border-[#1a2235]">
            <h2 className="text-3xl font-light text-[#e8edf5] mb-4">
              Own a Polestar? Protect Your Investment
            </h2>
            <p className="text-[#8a919e] text-lg mb-8 max-w-2xl">
              Our premium ceramic coating and PPF services keep your Polestar looking showroom-new for years.
            </p>
      ...
      <BrandHubSections brandSlug="polestar" />
