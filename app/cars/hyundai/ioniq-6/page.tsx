...
export default function HyundaiIoniq6Page() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Ioniq 6</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Hyundai Ioniq 6</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The electric streamliner. With its stunning teardrop silhouette and class-leading 
              aerodynamics, the Ioniq 6 delivers exceptional efficiency and an impressive 361-mile range.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00287a]">$46,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">361 mi</div>
                <div className="text-sm text-[#6b7a94]">EPA Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">5.1s</div>
                <div className="text-sm text-[#6b7a94]">0-60 mph</div>
              </div>
            </div>

            <div className="flex gap-4">
              <a href="https://www.hyundaiusa.com" target="_blank" rel="noopener noreferrer sponsored" className="px-6 py-3 bg-[#00287a] text-white rounded-lg font-medium hover:bg-[#003399] transition-colors flex items-center gap-2">
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/hyundai/ioniq-6.png" alt="Hyundai Ioniq 6" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="Hyundai" model="Ioniq 6" slug="hyundai/ioniq-6" range={361} theme="sapphire" />
      <MaintenanceSchedule brand="Hyundai" model="Ioniq 6" theme="sapphire" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Link href="/cars/polestar/polestar-2" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Polestar 2</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
          </div>
          <div className="mt-4">
