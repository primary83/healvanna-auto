...
export default function HyundaiKonaElectricPage() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Kona Electric</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Hyundai Kona Electric</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The fun and affordable way into electric driving. The Kona Electric offers 
              261 miles of range in a sporty, compact package perfect for urban adventures.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00287a]">$35,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">261 mi</div>
                <div className="text-sm text-[#6b7a94]">EPA Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">5.8s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/hyundai/kona-electric.png" alt="Hyundai Kona Electric" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="Hyundai" model="Kona Electric" slug="hyundai/kona-electric" range={261} theme="sapphire" />
      <MaintenanceSchedule brand="Hyundai" model="Kona Electric" theme="sapphire" />
