...
export default function ToyotaBrand() {
  const models = [
    {
      name: "bZ4X",
      slug: "bz4x",
      image: "/cars/toyota/bz4x.png",
      startingPrice: "$38,520",
      range: "252 miles",
      acceleration: "6.6s 0-60",
      topSpeed: "100 mph",
      description: "Toyota\u0027s first dedicated electric SUV. Built on the e-TNGA platform with available solar charging roof and all-wheel drive."
    },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center p-3">
              <span className="text-[#EB0A1E] font-bold text-2xl tracking-tight">TOYOTA</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">Toyota</h1>
              <p className="text-slate-400">Electric Vehicles &bull; Founded 1937 &bull; Toyota City, Japan</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">252 mi</div>
              <div className="text-sm text-slate-400">Max Range</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">6.6s</div>
              <div className="text-sm text-slate-400">Fastest 0-60</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">e-TNGA</div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-bold text-white mb-8">All Toyota Models</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {models.map((model) => (
              <Link
                key={model.slug}
                href={`/cars/toyota/${model.slug}`}
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden">
                  <Image src={model.image} alt={`Toyota ${model.name}`} fill className="object-cover" />
                  <div className="absolute top-3 right-3 px-3 py-1 bg-red-600 text-white text-xs font-semibold rounded-full">Toyota</div>
                </div>

                <div className="p-5">
                  <h3 className="text-xl font-bold text-white mb-2 group-hover:text-emerald-400 transition-colors">Toyota {model.name}</h3>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-red-900/20 to-slate-800/50 rounded-3xl p-8 md:p-12 border border-red-500/20">
            <h2 className="text-2xl font-bold text-white mb-6">Why Choose Toyota?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Legendary Quality</h3>
                <p className="text-slate-400 text-sm">Decades of manufacturing excellence and the most trusted name in automotive reliability.</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Solar Roof Option</h3>
                <p className="text-slate-400 text-sm">Available solar charging roof adds range through renewable energy while parked.</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Toyota Safety Sense</h3>
                <p className="text-slate-400 text-sm">Comprehensive safety suite with pre-collision system, lane departure alert, and adaptive cruise.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-3xl p-8 md:p-12 border border-emerald-500/20">
            <div className="max-w-2xl">
              <h2 className="text-2xl font-bold text-white mb-4">Own a Toyota? Protect Your Investment</h2>
              <p className="text-slate-300 mb-6">Our premium ceramic coating and PPF services keep your Toyota looking showroom-new for years.</p>
      ...
      <BrandHubSections brandSlug="toyota" />
