  ...
  const models = [
    {
      ...
      tag: "EV",
      description:
        "Toyota's first dedicated electric SUV. Built on the e-TNGA platform with available solar charging roof and all-wheel drive.",
      range: "252 mi",
      acceleration: "6.6s",
      power: "201-214 hp",
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-8 px-6 md:px-12 border-b border-[#1a2235]">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-8">
          ...
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">252 mi</span>
            <p className="text-sm text-[#6b7a94] mt-1">Max Range</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">6.6s</span>
            <p className="text-sm text-[#6b7a94] mt-1">Fastest 0-60</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">e-TNGA</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="w-32 h-24 bg-gradient-to-br from-red-900/20 to-[#0d1420] rounded-xl flex items-center justify-center border border-[#1a2235]">
              <span className="text-[#EB0A1E] font-bold text-lg tracking-wide">TOYOTA</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-light text-[#e8edf5]">Toyota</h1>
              <p className="text-[#6b7a94] mt-1">Let&apos;s Go Places. Electrically.</p>
            </div>
          </div>

          <p className="text-[#8a919e] max-w-3xl leading-relaxed">
            Toyota brings decades of hybrid expertise to the fully electric bZ4X. As the world&apos;s
            largest automaker, Toyota&apos;s commitment to quality and reliability extends to its
            growing lineup of battery electric vehicles.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-light text-[#e8edf5] mb-8">All Toyota EV Models</h2>
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-red-900/20 to-[#0d1420] overflow-hidden">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-gradient-to-r from-red-900/40 to-red-800/30 text-[#EB0A1E] text-[10px] font-bold px-3 py-1 rounded border border-red-700/20">
                      TOYOTA
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#111927] to-[#0d1420] rounded-2xl p-10 border border-[#1a2235]">
            <h2 className="text-3xl font-light text-[#e8edf5] mb-4">
              Own a Toyota? Protect Your Investment
            </h2>
            <p className="text-[#8a919e] text-lg mb-8 max-w-2xl">
              Our premium ceramic coating and PPF services keep your Toyota looking showroom-new for years.
            </p>
