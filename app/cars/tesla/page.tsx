      ...
      <section className="px-4 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link href="/cars/lucid" className="block px-6 py-4 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 hover:bg-slate-800/50 transition-all text-center">
                <div className="text-white font-medium mb-1">Lucid</div>
                <div className="text-emerald-400 text-sm">View Models →</div>
              </Link>
