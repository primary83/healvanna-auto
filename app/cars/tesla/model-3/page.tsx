...
export default function TeslaModel3() {
  ...
  const features = [
    ...
    { icon: "🚗", title: "Autopilot", description: "Advanced driver assistance with automatic steering, braking, and lane changes." },
  ...
  return (
    <main className="min-h-screen bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl font-bold text-white mb-4">Tesla Model 3</h1>
      ...
      <MaintenanceSchedule brand="Tesla" model="Model 3" theme="slate" />
