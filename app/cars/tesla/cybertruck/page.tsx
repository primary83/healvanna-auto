...
export default function TeslaCybertruck() {
  ...
  const features = [
    { icon: "🛡️", title: "Exoskeleton", description: "Ultra-hard 30X cold-rolled stainless steel structural skin. Nearly impenetrable." },
    { icon: "💪", title: "Towing Capacity", description: "Up to 11,000 lbs of towing capacity. Haul anything you need." },
    { icon: "🔋", title: "PowerShare", description: "Bi-directional charging. Power your home, tools, or another EV." },
    { icon: "🏔️", title: "Off-Road", description: "17 inches of ground clearance. Conquer any terrain." }
  ];
  ...
  return (
    <main className="min-h-screen bg-slate-950">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-500/20 rounded-full text-red-400 text-sm mb-4">
                <span>Tesla</span>
                <span>•</span>
                <span>Electric Pickup Truck</span>
              </div>
              <h1 className="text-5xl font-bold text-white mb-4">Tesla Cybertruck</h1>
              <p className="text-xl text-slate-300 mb-8">
                The revolutionary stainless steel electric truck that's unlike anything else on the road. Built to be nearly impenetrable with an exoskeleton design.
              </p>
              
              <div className="flex gap-8 mb-8">
                <div>
                  <div className="text-3xl font-bold text-emerald-400">$60,990</div>
                ...
                <div>
                  <div className="text-3xl font-bold text-white">2.6s</div>
                  <div className="text-slate-400">0-60 (Beast)</div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="aspect-video bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl flex items-center justify-center border border-slate-700/50 overflow-hidden">
                <img 
                  src="/cars/tesla/cybertruck.png" 
                  alt="Tesla Cybertruck"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="absolute bottom-4 right-4 px-3 py-1 bg-slate-700 rounded-full text-white text-sm font-medium">
                Stainless Steel
              </div>
            </div>
          </div>
      ...
      <ChargingSection brand="Tesla" model="Cybertruck" slug="tesla/cybertruck" range={318} theme="slate" />
      <MaintenanceSchedule brand="Tesla" model="Cybertruck" theme="slate" />
