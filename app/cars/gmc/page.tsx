  ...
  const models = [
    {
      ...
      year: "2024",
      price: "From $98,845",
      type: "SUPERTRUCK ELECTRIC SUV",
      tag: "EV",
      description:
        "The world's first all-electric supertruck SUV. Massive capability meets zero-emission luxury with CrabWalk and Extract Mode.",
      range: "314 mi",
      acceleration: "3.5s",
      power: "830 hp",
    ...
    },
    {
      ...
      year: "2024",
      price: "From $106,945",
      type: "SUPERTRUCK ELECTRIC PICKUP",
      tag: "EV",
      description:
        "1,000 horsepower of electric dominance. The Hummer EV Pickup redefines what a truck can be with Watts to Freedom launch mode.",
      range: "329 mi",
      acceleration: "3.0s",
      power: "1,000 hp",
    ...
    },
    {
      ...
      year: "2024",
      price: "From $99,495",
      type: "PREMIUM ELECTRIC TRUCK",
      tag: "EV",
      description:
        "The premium electric truck with class-leading range. Sierra EV combines workhorse capability with Denali luxury.",
      range: "440 mi",
      acceleration: "4.5s",
      power: "754 hp",
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-8 px-6 md:px-12 border-b border-[#1a2235]">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-8">
          ...
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">440 mi</span>
            <p className="text-sm text-[#6b7a94] mt-1">Max Range</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">3.0s</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="w-32 h-24 bg-gradient-to-br from-red-900/20 to-[#0d1420] rounded-xl flex items-center justify-center border border-[#1a2235]">
              <span className="text-[#CC0000] font-bold text-lg tracking-wide">GMC</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-light text-[#e8edf5]">GMC</h1>
              <p className="text-[#6b7a94] mt-1">Professional Grade. Electric Power.</p>
            </div>
          </div>

          <p className="text-[#8a919e] max-w-3xl leading-relaxed">
            GMC brings professional-grade capability to the electric era with the most powerful
            lineup in the EV truck segment. From the revolutionary Hummer EV to the refined
            Sierra EV Denali, GMC delivers uncompromising performance with zero emissions.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-light text-[#e8edf5] mb-8">All GMC EV Models</h2>
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-red-900/20 to-[#0d1420] overflow-hidden">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-gradient-to-r from-red-900/40 to-red-800/30 text-[#CC0000] text-[10px] font-bold px-3 py-1 rounded border border-red-700/20">
                      GMC
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#111927] to-[#0d1420] rounded-2xl p-10 border border-[#1a2235]">
            <h2 className="text-3xl font-light text-[#e8edf5] mb-4">
              Own a GMC? Protect Your Investment
            </h2>
            <p className="text-[#8a919e] text-lg mb-8 max-w-2xl">
              Our premium ceramic coating and PPF services keep your GMC looking showroom-new for years.
            </p>
