...
export default function VolvoXC40RechargePage() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <section className="px-12 py-12">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl font-light tracking-tight mb-4">XC40 Recharge</h1>
            <p className="text-xl text-[#8a9bb5] mb-6">The versatile compact SUV, now fully electric. Premium comfort and capability with zero tailpipe emissions.</p>
            <div className="text-3xl font-light text-[#1c6bba] mb-8">$53,550 <span className="text-base text-[#6b7a94]">Starting MSRP</span></div>
            
            <div className="grid grid-cols-4 gap-6 mb-8">
              <div className="bg-[#0d1424] rounded-xl p-4 text-center">
                <div className="text-2xl font-light text-[#1c6bba]">254 mi</div>
          ...
          <div className="relative h-[500px]">
            <Image
              src="/cars/volvo/xc40-recharge.png"
      ...
      <section className="px-12 py-16 bg-[#0d1424]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Google Built-In", desc: "Google Maps, Google Assistant, and Google Play Store fully integrated." },
              { title: "One Pedal Drive", desc: "Regenerative braking lets you drive with just the accelerator pedal." },
              { title: "Versatile Interior", desc: "Flexible cargo space and clever storage solutions throughout." },
              { title: "Pilot Assist", desc: "Semi-autonomous driving assistance for highway comfort." },
              { title: "Fast Charging", desc: "10-80% in approximately 37 minutes with DC fast charging." },
              { title: "Advanced Safety", desc: "Comprehensive safety suite with collision avoidance technology." },
            ].map((feature, i) => (
      ...
      <ChargingSection brand="Volvo" model="XC40 Recharge" slug="xc40-recharge" range={254} theme="sapphire" />
