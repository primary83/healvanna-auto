...
export default function NIOET5Page() {
  const variants = [
    { name: "ET5 75kWh", price: "$52,000", range: "295 mi", acceleration: "4.3s", power: "483 hp", battery: "75 kWh" },
    { name: "ET5 100kWh", price: "$59,000", range: "340 mi", acceleration: "4.3s", power: "483 hp", battery: "100 kWh", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">ET5</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">NIO ET5</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              A sporty mid-size sedan that brings NIO's premium technology to a more accessible price point. Features the same advanced NAD autonomous driving system as the flagship ET7.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00bfff]">$52,000</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/nio/et5.png" alt="NIO ET5" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Compact Design", desc: "BMW 3 Series rival with sporty proportions" },
              { title: "AR/VR Ready", desc: "Immersive entertainment with AR glasses" },
              { title: "Battery Swap", desc: "Compatible with NIO Power Swap stations" },
              { title: "Premium Audio", desc: "Dolby Atmos 7.1.4 surround sound system" },
            ].map((feature) => (
      ...
      <ChargingSection brand="NIO" model="ET5" slug="nio/et5" range={340} theme="sapphire" />
      <MaintenanceSchedule brand="NIO" model="ET5" theme="sapphire" />
