...
export default function NIOEC7Page() {
  const variants = [
    { name: "EC7 75kWh", price: "$72,000", range: "310 mi", acceleration: "3.8s", power: "644 hp", battery: "75 kWh" },
    { name: "EC7 100kWh", price: "$79,000", range: "355 mi", acceleration: "3.8s", power: "644 hp", battery: "100 kWh", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">EC7</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">NIO EC7</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              A stunning coupe SUV that combines dramatic styling with flagship performance. The EC7 features the same powertrain as the ET7 in a sleeker, sportier body.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00bfff]">$72,000</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">355 mi</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/nio/ec7.png" alt="NIO EC7" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Coupe Roofline", desc: "Dramatic fastback design with 0.24 Cd" },
              { title: "AQUILA Sensing", desc: "33 sensors for advanced autonomy" },
              { title: "Battery Swap", desc: "3-minute swap at NIO stations" },
              { title: "Smart Glass Roof", desc: "Electrochromic panoramic roof" },
            ].map((feature) => (
