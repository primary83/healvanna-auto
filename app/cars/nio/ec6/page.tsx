...
export default function NIOEC6Page() {
  const variants = [
    { name: "EC6 75kWh", price: "$62,000", range: "295 mi", acceleration: "4.5s", power: "536 hp", battery: "75 kWh" },
    { name: "EC6 100kWh", price: "$69,000", range: "340 mi", acceleration: "4.5s", power: "536 hp", battery: "100 kWh", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">EC6</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">NIO EC6</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              A sporty coupe SUV that combines style with practicality. The EC6 offers the sleek looks of a coupe with the versatility of an SUV in a more compact package.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00bfff]">$62,000</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/nio/ec6.png" alt="NIO EC6" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="NIO" model="EC6" slug="nio/ec6" range={340} theme="sapphire" />
      <MaintenanceSchedule brand="NIO" model="EC6" theme="sapphire" />
