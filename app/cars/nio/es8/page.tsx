...
export default function NIOES8Page() {
  const variants = [
    { name: "ES8 75kWh", price: "$75,000", range: "265 mi", acceleration: "4.1s", power: "536 hp", battery: "75 kWh", seats: "6/7" },
    { name: "ES8 100kWh", price: "$82,000", range: "310 mi", acceleration: "4.1s", power: "536 hp", battery: "100 kWh", seats: "6/7", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">ES8</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">NIO ES8</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              NIO's flagship full-size SUV offering three rows of premium seating, commanding presence, and all the technology that defines the NIO brand. The ultimate family electric vehicle.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00bfff]">$75,000</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">310 mi</div>
                <div className="text-sm text-[#6b7a94]">Max Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">4.1s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/nio/es8.png" alt="NIO ES8" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "6 or 7 Seats", desc: "Flexible seating configurations for families" },
              { title: "Air Suspension", desc: "Adaptive air suspension for comfort" },
              { title: "Battery Swap", desc: "3-minute swap at NIO Power stations" },
              { title: "Executive Package", desc: "Rear entertainment and massage seats" },
            ].map((feature) => (
      ...
      <ChargingSection brand="NIO" model="ES8" slug="nio/es8" range={310} theme="sapphire" />
      <MaintenanceSchedule brand="NIO" model="ES8" theme="sapphire" />
