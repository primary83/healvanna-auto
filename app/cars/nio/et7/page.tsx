...
export default function NIOET7Page() {
  const variants = [
    { name: "ET7 75kWh", price: "$69,000", range: "310 mi", acceleration: "3.8s", power: "644 hp", battery: "75 kWh" },
    { name: "ET7 100kWh", price: "$76,000", range: "360 mi", acceleration: "3.8s", power: "644 hp", battery: "100 kWh", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">ET7</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">NIO ET7</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              NIO's flagship sedan featuring industry-leading autonomous driving hardware, luxurious interior with sustainable materials, and the option of battery swap technology.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#00bfff]">$69,000</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/nio/et7.png" alt="NIO ET7" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "AQUILA Super Sensing", desc: "33 sensors including LiDAR for advanced autonomy" },
              { title: "ADAM Supercomputer", desc: "1,016 TOPS computing power for NAD" },
              { title: "Battery Swap", desc: "3-minute battery swap at NIO stations" },
              { title: "NOMI AI", desc: "Emotional AI companion with personality" },
            ].map((feature) => (
      ...
      <MaintenanceSchedule brand="NIO" model="ET7" theme="sapphire" />
