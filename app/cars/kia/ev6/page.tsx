    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">EV6</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Kia EV6</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The award-winning electric crossover that redefined what a Kia can be. With stunning 
              design, ultra-fast 800V charging, and thrilling performance, the EV6 is a game-changer.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#4a90d9]">$44,000</div>
            ...
            <div className="flex gap-4">
              <a href="https://www.kia.com" target="_blank" rel="noopener noreferrer sponsored" className="px-6 py-3 bg-[#05141f] text-white rounded-lg font-medium hover:bg-[#0a2540] transition-colors flex items-center gap-2">
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/kia/ev6.png" alt="Kia EV6" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <MaintenanceSchedule brand="Kia" model="EV6" theme="sapphire" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Link href="/cars/ford/mustang-mach-e" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Ford Mustang Mach-E</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
          </div>
          <div className="mt-4">
