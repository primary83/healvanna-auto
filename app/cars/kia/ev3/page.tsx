...
export default function KiaEV3Page() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">EV3</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Kia EV3</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The affordable entry into Kia's electric lineup. Compact, efficient, and fun to drive,
              the EV3 brings premium EV technology to a wider audience.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#4a90d9]">$35,000</div>
              ...
              <div>
                <div className="text-3xl font-light">7.5s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/kia/ev3.png" alt="Kia EV3" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="Kia" model="EV3" slug="kia/ev3" range={311} theme="sapphire" />
      <MaintenanceSchedule brand="Kia" model="EV3" theme="sapphire" />
      ...
      <section className="py-16 px-6 md:px-12 bg-[#0d1424]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: "Range", value: "311 mi" },
              { label: "0-60 mph", value: "7.5s" },
