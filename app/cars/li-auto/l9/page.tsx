...
export default function LiAutoL9Page() {
  const variants = [
    { name: "L9 Pro", price: "$69,000", evRange: "130 mi", totalRange: "750 mi", acceleration: "5.3s", power: "449 hp", seats: "6" },
    { name: "L9 Max", price: "$75,000", evRange: "130 mi", totalRange: "750 mi", acceleration: "5.3s", power: "449 hp", seats: "6", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">L9</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Li Auto L9</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              Li Auto's flagship full-size SUV offering unmatched luxury and space for families. The L9 combines extended-range technology with premium features and a commanding presence.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#f97316]">$69,000</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">750 mi</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/li-auto/l9.png" alt="Li Auto L9" fill className="object-cover" priority />
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl">
            {variants.map((variant) => (
              <div key={variant.name} className={`p-6 rounded-xl border ${variant.highlight ? "border-[#f97316] bg-gradient-to-b from-[rgba(249,115,22,0.1)] to-transparent" : "border-[rgba(74,144,217,0.15)] bg-[rgba(15,22,40,0.5)]"}`}>
                {variant.highlight && <div className="text-xs tracking-wider text-[#f97316] font-semibold mb-2 uppercase">Flagship</div>}
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "6-Seat Luxury", desc: "Executive second-row with massage and heating" },
              { title: "Dual Screens", desc: "Rear entertainment displays for passengers" },
              { title: "Air Suspension", desc: "Adaptive air suspension for ultimate comfort" },
              { title: "AD Max", desc: "Advanced driver assistance with LiDAR" },
            ].map((feature) => (
      ...
      <ChargingSection brand="Li Auto" model="L9" slug="li-auto/l9" range={750} theme="sapphire" />
      <MaintenanceSchedule brand="Li Auto" model="L9" theme="sapphire" />
