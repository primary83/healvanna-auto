...
export default function LiAutoL6Page() {
  const variants = [
    { name: "L6 Pro", price: "$42,000", evRange: "110 mi", totalRange: "700 mi", acceleration: "5.4s", power: "396 hp", seats: "5" },
    { name: "L6 Max", price: "$48,000", evRange: "110 mi", totalRange: "700 mi", acceleration: "5.4s", power: "396 hp", seats: "5", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">L6</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Li Auto L6</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              Li Auto's entry-level luxury SUV brings the brand's signature technology and comfort to a more accessible price point. The L6 offers the perfect balance of value and premium features.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#f97316]">$42,000</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">700 mi</div>
                <div className="text-sm text-[#6b7a94]">Total Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">5.4s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/li-auto/l6.png" alt="Li Auto L6" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Best Value", desc: "Premium Li Auto experience at entry price" },
              { title: "Compact Size", desc: "Perfect for city driving and parking" },
              { title: "Smart Cockpit", desc: "Same software experience as flagship models" },
              { title: "AD Pro", desc: "Highway NOA and smart parking" },
            ].map((feature) => (
      ...
      <ChargingSection brand="Li Auto" model="L6" slug="li-auto/l6" range={700} theme="sapphire" />
      <MaintenanceSchedule brand="Li Auto" model="L6" theme="sapphire" />
