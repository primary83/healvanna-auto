...
export default function XPengG9Page() {
  const variants = [
    { name: "G9 RWD Long Range", price: "$52,000", range: "350 mi", acceleration: "6.4s", power: "313 hp", battery: "98 kWh" },
    { name: "G9 AWD Performance", price: "$58,000", range: "320 mi", acceleration: "3.9s", power: "543 hp", battery: "98 kWh", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">G9</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">XPeng G9</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              XPeng's flagship SUV featuring the world's fastest production EV charging technology and advanced XNGP autonomous driving system.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#10b981]">$52,000</div>
            ...
            <div className="flex gap-4">
              <a href="https://www.xpeng.com" target="_blank" rel="noopener noreferrer sponsored" className="px-6 py-3 bg-[#10b981] text-white rounded-lg font-medium hover:bg-[#059669] transition-colors flex items-center gap-2">
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/xpeng/g9.png" alt="XPeng G9" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "480kW Charging", desc: "World's fastest EV charging - 10-80% in 10 min" },
              { title: "XNGP", desc: "City and highway autonomous navigation" },
              { title: "800V Architecture", desc: "Ultra-efficient high-voltage platform" },
              { title: "3D UI", desc: "Next-gen digital cockpit experience" },
            ].map((feature) => (
      ...
      <ChargingSection brand="Li Auto" model="G9" slug="li-auto/g9" range={350} theme="sapphire" />
      <MaintenanceSchedule brand="Li Auto" model="G9" theme="sapphire" />
