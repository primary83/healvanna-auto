...
export default function LiAutoL8Page() {
  const variants = [
    { name: "L8 Pro", price: "$56,000", evRange: "120 mi", totalRange: "740 mi", acceleration: "5.5s", power: "449 hp", seats: "6" },
    { name: "L8 Max", price: "$62,000", evRange: "120 mi", totalRange: "740 mi", acceleration: "5.5s", power: "449 hp", seats: "6", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">L8</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Li Auto L8</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              A versatile mid-large luxury SUV that perfectly balances space, comfort, and value. The L8 offers 6-seat flexibility with premium Li Auto features at a more accessible price.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#f97316]">$56,000</div>
              ...
              <div>
                <div className="text-3xl font-light">5.5s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/li-auto/l8.png" alt="Li Auto L8" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "6-Seat Flexibility", desc: "2+2+2 layout with versatile configurations" },
              { title: "Smart Cockpit", desc: "15.7\" + 12.3\" dual-screen setup" },
              { title: "21 Speakers", desc: "Premium audio by Harman Kardon" },
              { title: "AD Pro", desc: "Highway NOA and parking assistance" },
            ].map((feature) => (
      ...
      <ChargingSection brand="Li Auto" model="L8" slug="li-auto/l8" range={740} theme="sapphire" />
      <MaintenanceSchedule brand="Li Auto" model="L8" theme="sapphire" />
