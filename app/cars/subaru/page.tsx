...
export default function SubaruPage() {
  const models = [
    {
      id: "subaru-solterra",
      ...
      tag: "EV",
      description:
        "Subaru's first all-electric SUV combines symmetrical AWD heritage with zero-emission driving for outdoor adventures.",
      range: "227 mi",
      acceleration: "6.5s",
      power: "215 hp",
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-8 px-6 md:px-12 border-b border-[#1a2235]">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-8">
          ...
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">227 mi</span>
            <p className="text-sm text-[#6b7a94] mt-1">Max Range</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">6.5s</span>
            <p className="text-sm text-[#6b7a94] mt-1">Fastest 0-60</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">S-AWD</span>
            <p className="text-sm text-[#6b7a94] mt-1">Symmetrical AWD</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="w-32 h-24 bg-gradient-to-br from-blue-900/20 to-[#0d1420] rounded-xl flex items-center justify-center border border-[#1a2235]">
              <span className="text-[#003C82] font-bold text-lg tracking-wide">SUBARU</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-light text-[#e8edf5]">Subaru</h1>
              <p className="text-[#6b7a94] mt-1">Love. Now Electrified.</p>
            </div>
          </div>

          <p className="text-[#8a919e] max-w-3xl leading-relaxed">
            Subaru extends its legendary all-wheel drive capability into the electric future
            with the Solterra. Built for adventure-seekers who want to explore without
            compromise, combining Subaru&apos;s rugged heritage with zero-emission driving.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-light text-[#e8edf5] mb-8">All Subaru EV Models</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {models.map((model) => (
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-blue-900/20 to-[#0d1420] overflow-hidden">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-gradient-to-r from-blue-900/40 to-blue-800/30 text-[#003C82] text-[10px] font-bold px-3 py-1 rounded border border-blue-700/20">
                      SUBARU
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#111927] to-[#0d1420] rounded-2xl p-10 border border-[#1a2235]">
            <h2 className="text-3xl font-light text-[#e8edf5] mb-4">
              Own a Subaru? Protect Your Investment
            </h2>
            <p className="text-[#8a919e] text-lg mb-8 max-w-2xl">
              Our premium ceramic coating and PPF services keep your Subaru looking showroom-new for years.
            </p>
