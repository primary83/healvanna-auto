...
export default function VF9Page() {
  const variants = [{ name: "Eco", price: "$73,950", range: "330 mi", power: "348 hp" }, { name: "Plus", price: "$79,950", range: "313 mi", power: "402 hp" }];
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-light text-[#e8edf5] mb-2">VinFast VF 9</h1>
            <p className="text-[#4a90d9] text-lg mb-4">2024 • From $73,950</p>
            <p className="text-[#8a919e] mb-8 max-w-lg">The premium three-row SUV for families who demand space, luxury, and zero-emission driving.</p>
            <div className="flex gap-8 mb-8"><div><span className="text-3xl font-light text-[#4a90d9]">330 mi</span><p className="text-sm text-[#6b7a94]">Range</p></div><div><span className="text-3xl font-light text-[#4a90d9]">6.5s</span><p className="text-sm text-[#6b7a94]">0-60 mph</p></div><div><span className="text-3xl font-light text-[#4a90d9]">402 hp</span><p className="text-sm text-[#6b7a94]">Power</p></div></div>
          ...
          <div className="relative h-[400px] lg:h-[500px]"><Image src="/cars/vinfast/vf9.jpg" alt="VinFast VF 9" fill className="object-contain" priority /></div>
        </div>
      </div>
      <div className="px-6 md:px-12 py-12 bg-[#0d1420]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]"><h3 className="text-[#4a90d9] font-medium mb-4">Performance</h3><div className="space-y-3"><div className="flex justify-between"><span className="text-[#6b7a94]">Horsepower</span><span className="text-[#e8edf5]">402 hp</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Torque</span><span className="text-[#e8edf5]">457 lb-ft</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">0-60 mph</span><span className="text-[#e8edf5]">6.5 seconds</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Drive</span><span className="text-[#e8edf5]">AWD</span></div></div></div>
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]"><h3 className="text-[#4a90d9] font-medium mb-4">Battery & Charging</h3><div className="space-y-3"><div className="flex justify-between"><span className="text-[#6b7a94]">Battery Capacity</span><span className="text-[#e8edf5]">123 kWh</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Range (EPA)</span><span className="text-[#e8edf5]">330 miles</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">DC Fast Charging</span><span className="text-[#e8edf5]">230 kW</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Charge Time (10-70%)</span><span className="text-[#e8edf5]">35 min</span></div></div></div>
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]"><h3 className="text-[#4a90d9] font-medium mb-4">Dimensions</h3><div className="space-y-3"><div className="flex justify-between"><span className="text-[#6b7a94]">Length</span><span className="text-[#e8edf5]">201.3 in</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Width</span><span className="text-[#e8edf5]">78.2 in</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Height</span><span className="text-[#e8edf5]">69.8 in</span></div><div className="flex justify-between"><span className="text-[#6b7a94]">Seating</span><span className="text-[#e8edf5]">7 Passengers</span></div></div></div>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-12 bg-[#0d1420]"><div className="max-w-7xl mx-auto"><h2 className="text-2xl font-light text-[#e8edf5] mb-8">Key Features</h2><div className="grid md:grid-cols-4 gap-4">{["15.6\" Central Display", "ADAS Highway Assist", "7-Seat Configuration", "Panoramic Sunroof", "Captain's Chairs Option", "V2L Capability", "Premium 14-Speaker", "OTA Updates"].map((f) => (<div key={f} className="bg-[#111927] rounded-lg p-4 border border-[#1a2235]"><span className="text-[#e8edf5] text-sm">{f}</span></div>))}</div></div></div>
      ...
      <ChargingSection brand="VinFast" model="VF 9" slug="vinfast/vf9" range={330} theme="sapphire" />
      <MaintenanceSchedule brand="VinFast" model="VF 9" theme="sapphire" />
