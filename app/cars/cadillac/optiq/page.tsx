...
export default function OptiqPage() {
  const variants = [
    { name: "Luxury", price: "$54,000", range: "300 mi", power: "300 hp" },
    { name: "Sport", price: "$58,000", range: "295 mi", power: "300 hp" },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[#4a90d9] text-lg mb-4">2024 • From $54,000</p>
            <p className="text-[#8a919e] mb-8 max-w-lg">
              Accessible luxury meets electric efficiency. The OPTIQ brings Cadillac's 
              bold design language to the compact luxury SUV segment.
            </p>
            ...
            <div className="flex gap-8 mb-8">
              ...
              <div>
                <span className="text-3xl font-light text-[#4a90d9]">5.8s</span>
                <p className="text-sm text-[#6b7a94]">0-60 mph</p>
              </div>
              <div>
                <span className="text-3xl font-light text-[#4a90d9]">300 hp</span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between"><span className="text-[#6b7a94]">Horsepower</span><span className="text-[#e8edf5]">300 hp</span></div>
                <div className="flex justify-between"><span className="text-[#6b7a94]">Torque</span><span className="text-[#e8edf5]">354 lb-ft</span></div>
                <div className="flex justify-between"><span className="text-[#6b7a94]">0-60 mph</span><span className="text-[#e8edf5]">5.8 seconds</span></div>
                <div className="flex justify-between"><span className="text-[#6b7a94]">Drive</span><span className="text-[#e8edf5]">RWD / AWD</span></div>
              </div>
            </div>
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
            ...
            <div className="bg-[#111927] rounded-xl p-6 border border-[#1a2235]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between"><span className="text-[#6b7a94]">Length</span><span className="text-[#e8edf5]">184.7 in</span></div>
                <div className="flex justify-between"><span className="text-[#6b7a94]">Width</span><span className="text-[#e8edf5]">73.9 in</span></div>
                <div className="flex justify-between"><span className="text-[#6b7a94]">Height</span><span className="text-[#e8edf5]">63.8 in</span></div>
                <div className="flex justify-between"><span className="text-[#6b7a94]">Cargo Space</span><span className="text-[#e8edf5]">26 cu ft</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="px-6 md:px-12 py-12 bg-[#0d1420]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {["33\" Curved Display", "Super Cruise Available", "AKG Audio System", "LED Lighting Signature", "Hands-Free Liftgate", "Wireless Charging", "One-Pedal Driving", "OTA Updates"].map((feature) => (
      ...
      <MaintenanceSchedule brand="Cadillac" model="OPTIQ" theme="sapphire" />
