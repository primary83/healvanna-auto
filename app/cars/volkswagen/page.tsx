    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <section className="py-20 px-6 md:px-12 bg-[#0d1424]">
        <div className="max-w-[800px] mx-auto text-center">
          <h2 className="text-2xl font-light mb-4">Own a Volkswagen? Protect Your Investment</h2>
          <p className="text-[#6b7a94] mb-8">Our premium ceramic coating and PPF services keep your Volkswagen looking showroom-new for years.</p>
