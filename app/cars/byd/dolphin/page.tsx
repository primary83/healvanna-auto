...
export default function BYDDolphinPage() {
  const variants = [
    { name: "Dolphin", price: "$31,900", range: "230 mi", acceleration: "7.0s", power: "95 hp", drive: "FWD" },
    { name: "Dolphin Extended Range", price: "$34,900", range: "265 mi", acceleration: "7.0s", power: "201 hp", drive: "FWD", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Dolphin</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">BYD Dolphin</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              An affordable and fun compact EV with playful design and solid range. The Dolphin makes electric driving accessible without compromising on style or features.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#c72126]">$31,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">265 mi</div>
                <div className="text-sm text-[#6b7a94]">Max Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">7.0s</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl">
            {variants.map((variant) => (
              ...
              >
                {variant.highlight && (
                  <div className="text-xs tracking-wider text-[#c72126] font-semibold mb-2 uppercase">Best Value</div>
                )}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { title: "Playful Design", desc: "Ocean-inspired interior aesthetics" },
              { title: "Compact Size", desc: "Easy parking and urban maneuvers" },
              { title: "V2L Capable", desc: "Power external devices on the go" },
            ].map((feature) => (
