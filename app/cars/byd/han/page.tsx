...
export default function BYDHanPage() {
  const variants = [
    { name: "Han EV", price: "$46,900", range: "375 mi", acceleration: "4.9s", power: "308 hp", drive: "RWD" },
    { name: "Han EV AWD", price: "$52,900", range: "348 mi", acceleration: "3.9s", power: "517 hp", drive: "AWD", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Han</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">BYD Han</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              BYD's flagship luxury sedan combining elegant design with cutting-edge EV technology. The Han delivers premium comfort, impressive range, and exhilarating performance.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#c72126]">$46,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">375 mi</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl">
            {variants.map((variant) => (
              ...
              >
                {variant.highlight && (
                  <div className="text-xs tracking-wider text-[#c72126] font-semibold mb-2 uppercase">Top Performance</div>
                )}
      ...
      <ChargingSection brand="BYD" model="Han" slug="byd/han" range={375} theme="sapphire" />
      <MaintenanceSchedule brand="BYD" model="Han" theme="sapphire" />
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Dragon Face Design", desc: "Iconic BYD design language" },
              { title: "Blade Battery", desc: "Ultra-safe LFP battery technology" },
              { title: "DiPilot", desc: "Advanced driver assistance system" },
              { title: "Premium Interior", desc: "Nappa leather and wood trim" },
            ].map((feature) => (
