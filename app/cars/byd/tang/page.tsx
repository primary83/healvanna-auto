...
export default function BYDTangPage() {
  const variants = [
    { name: "Tang EV", price: "$58,000", range: "313 mi", acceleration: "5.9s", power: "308 hp", drive: "FWD", seats: "7" },
    { name: "Tang EV AWD", price: "$65,000", range: "286 mi", acceleration: "4.6s", power: "517 hp", drive: "AWD", seats: "7", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Tang</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">BYD Tang</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              BYD's flagship 7-seater SUV combining family-friendly space with premium features and powerful dual-motor AWD capability. The ultimate electric family hauler.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#c72126]">$58,000</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">313 mi</div>
                <div className="text-sm text-[#6b7a94]">Max Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">4.6s</div>
            ...
            {variants.map((variant) => (
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[#6b7a94]">Seats</span>
                    <span>{variant.seats}</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <MaintenanceSchedule brand="BYD" model="Tang" theme="sapphire" />
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "7 Seats", desc: "Three rows of comfortable seating" },
              { title: "Blade Battery", desc: "Ultra-safe LFP battery technology" },
              { title: "DiPilot", desc: "Advanced driver assistance suite" },
