  ...
  const models = [
    {
      ...
      tag: "EV",
      description:
        "Honda's first all-electric SUV built on the Ultium platform. Spacious, tech-forward, and designed for everyday adventure.",
      range: "308 mi",
      acceleration: "6.4s",
      power: "220-300 hp",
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 pb-8 px-6 md:px-12 border-b border-[#1a2235]">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-8">
          ...
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">308 mi</span>
            <p className="text-sm text-[#6b7a94] mt-1">Max Range</p>
          </div>
          <div>
            <span className="text-4xl md:text-5xl font-light text-[#e8edf5]">6.4s</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="w-32 h-24 bg-gradient-to-br from-blue-900/20 to-[#0d1420] rounded-xl flex items-center justify-center border border-[#1a2235]">
              <span className="text-[#0B63CE] font-bold text-lg tracking-wide">HONDA</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-light text-[#e8edf5]">Honda</h1>
              <p className="text-[#6b7a94] mt-1">The Power of Dreams. Now Electric.</p>
            </div>
          </div>

          <p className="text-[#8a919e] max-w-3xl leading-relaxed">
            Honda enters the electric era with the Prologue, a spacious and capable SUV built on
            GM&apos;s proven Ultium platform. With up to 308 miles of range and Honda&apos;s
            legendary reliability, the Prologue makes going electric effortless.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-light text-[#e8edf5] mb-8">All Honda EV Models</h2>
              ...
              >
                ...
                <div className="relative h-48 bg-gradient-to-br from-blue-900/20 to-[#0d1420] overflow-hidden">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-gradient-to-r from-blue-900/40 to-blue-800/30 text-[#0B63CE] text-[10px] font-bold px-3 py-1 rounded border border-blue-700/20">
                      HONDA
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#111927] to-[#0d1420] rounded-2xl p-10 border border-[#1a2235]">
            <h2 className="text-3xl font-light text-[#e8edf5] mb-4">
              Own a Honda? Protect Your Investment
            </h2>
            <p className="text-[#8a919e] text-lg mb-8 max-w-2xl">
              Our premium ceramic coating and PPF services keep your Honda looking showroom-new for years.
            </p>
