  ...
  const models = [
    {
      ...
      topSpeed: "130 mph",
      description: "Honda's first all-electric SUV built on GM's Ultium platform. Spacious, tech-forward, and designed for everyday adventure."
    },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center p-3">
              <span className="text-red-600 font-bold text-2xl tracking-tight">HONDA</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">Honda</h1>
              <p className="text-slate-400">Electric Vehicles &bull; Founded 1948 &bull; Tokyo, Japan</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">296 mi</div>
              <div className="text-sm text-slate-400">Max Range</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              <div className="text-2xl font-bold text-emerald-400">6.4s</div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-bold text-white mb-8">All Honda Models</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {models.map((model) => (
              <Link
                key={model.slug}
                href={`/cars/honda/${model.slug}`}
              ...
              >
                <div className="relative h-48 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden">
                  <Image src={model.image} alt={`Honda ${model.name}`} fill className="object-cover" />
                  <div className="absolute top-3 right-3 px-3 py-1 bg-red-600 text-white text-xs font-semibold rounded-full">Honda</div>
                </div>

                <div className="p-5">
                  <h3 className="text-xl font-bold text-white mb-2 group-hover:text-emerald-400 transition-colors">Honda {model.name}</h3>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-red-900/20 to-slate-800/50 rounded-3xl p-8 md:p-12 border border-red-500/20">
            <h2 className="text-2xl font-bold text-white mb-6">Why Choose Honda?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Legendary Reliability</h3>
                <p className="text-slate-400 text-sm">Decades of engineering excellence and industry-leading reliability ratings you can count on.</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Honda Sensing</h3>
                <p className="text-slate-400 text-sm">Comprehensive suite of advanced safety and driver-assistance features comes standard.</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Ultium Platform</h3>
                <p className="text-slate-400 text-sm">Built on GM&apos;s proven Ultium architecture for exceptional range and fast DC charging.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-3xl p-8 md:p-12 border border-emerald-500/20">
            <div className="max-w-2xl">
              <h2 className="text-2xl font-bold text-white mb-4">Own a Honda? Protect Your Investment</h2>
              <p className="text-slate-300 mb-6">Our premium ceramic coating and PPF services keep your Honda looking showroom-new for years.</p>
