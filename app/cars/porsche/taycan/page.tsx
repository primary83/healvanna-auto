...
export default function PorscheTaycan() {
  ...
  return (
    <main className="min-h-screen bg-slate-950">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.porsche.com/usa/models/taycan/" target="_blank" rel="noopener noreferrer sponsored" className="px-6 py-3 bg-rose-500 hover:bg-rose-600 text-white rounded-lg font-medium transition-colors inline-flex items-center gap-2">
      ...
      <MaintenanceSchedule brand="Porsche" model="Taycan" theme="slate" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Link href="/cars/lucid/air-sapphire" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Lucid Air Sapphire</div>
                <div className="text-emerald-400 text-xs mt-1">Compare →</div>
              </Link>
          ...
          <div className="mt-4">
            <Link href="/cars/porsche" className="text-sm text-emerald-400 hover:text-emerald-300 transition-colors">
              ← All Porsche Models
            </Link>
          </div>
        </div>
