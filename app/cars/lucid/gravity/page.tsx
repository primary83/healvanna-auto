...
export default function LucidGravityPage() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Gravity</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Lucid Gravity</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              Lucid&apos;s first SUV brings the Air&apos;s groundbreaking technology to a spacious 
              7-seat package. Experience class-leading range and performance in a versatile luxury SUV.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#446688]">$79,900</div>
              ...
              <div>
                <div className="text-3xl font-light">3.5s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/lucid/gravity.png" alt="Lucid Gravity" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="Lucid" model="Gravity" slug="lucid/gravity" range={440} theme="sapphire" />
      <MaintenanceSchedule brand="Lucid" model="Gravity" theme="sapphire" />
