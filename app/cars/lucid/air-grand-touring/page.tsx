...
export default function LucidAirGrandTouringPage() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Air Grand Touring</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Lucid Air Grand Touring</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The ultimate expression of electric luxury. Industry-leading 516-mile range meets 
              breathtaking performance in the most capable grand tourer ever created.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#446688]">$109,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">516 mi</div>
                <div className="text-sm text-[#6b7a94]">EPA Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">3.0s</div>
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/lucid/air-grand-touring.png" alt="Lucid Air Grand Touring" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="Lucid" model="Air Grand Touring" slug="lucid/air-grand-touring" range={516} theme="sapphire" />
      <MaintenanceSchedule brand="Lucid" model="Air Grand Touring" theme="sapphire" />
