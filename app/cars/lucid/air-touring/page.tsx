    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">Air Touring</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Lucid Air Touring</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The perfect balance of performance and luxury. Dual-motor AWD delivers exhilarating 
              acceleration while maintaining impressive range for the ultimate touring experience.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#446688]">$77,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">425 mi</div>
                <div className="text-sm text-[#6b7a94]">EPA Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">3.4s</div>
                <div className="text-sm text-[#6b7a94]">0-60 mph</div>
              </div>
            </div>

            <div className="flex gap-4">
              <a href="https://www.lucidmotors.com" target="_blank" rel="noopener noreferrer sponsored" className="px-6 py-3 bg-[#446688] text-white rounded-lg font-medium hover:bg-[#557799] transition-colors flex items-center gap-2">
          ...
          <div className="relative h-[400px] rounded-2xl overflow-hidden">
            <Image src="/cars/lucid/air-touring.png" alt="Lucid Air Touring" fill className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <ChargingSection brand="Lucid" model="Air Touring" slug="lucid/air-touring" range={425} theme="sapphire" />
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <Link href="/cars/mercedes/eqs" className="block px-5 py-3.5 bg-slate-800/30 rounded-xl border border-slate-700/30 hover:border-emerald-500/30 transition-all">
                <div className="text-white font-medium text-sm">Mercedes EQS</div>
          ...
          <div className="mt-4">
            <Link href="/cars/lucid" className="text-sm text-emerald-400 hover:text-emerald-300 transition-colors">
              ← All Lucid Models
            </Link>
          </div>
        </div>
