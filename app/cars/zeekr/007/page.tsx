...
export default function Zeekr007Page() {
  const variants = [
    { name: "Zeekr 007 RWD", price: "$52,900", range: "438 mi", acceleration: "5.6s", power: "310 hp", drive: "RWD" },
    { name: "Zeekr 007 AWD", price: "$58,900", range: "388 mi", acceleration: "3.5s", power: "620 hp", drive: "AWD" },
    { name: "Zeekr 007 Performance", price: "$69,900", range: "365 mi", acceleration: "2.8s", power: "752 hp", drive: "AWD", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">007</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Zeekr 007</h1>
            ...
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#eaaa00]">$52,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">438 mi</div>
      ...
      <ChargingSection brand="Zeekr" model="007" slug="zeekr/007" range={438} theme="sapphire" />
      <MaintenanceSchedule brand="Zeekr" model="007" theme="sapphire" />
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Qilin Battery", desc: "Next-generation CATL battery for superior range" },
              { title: "800V Fast Charging", desc: "10% to 80% in just 15 minutes" },
              { title: "Lidar Integration", desc: "Advanced driver assistance with lidar sensor array" },
              { title: "0.21 Cd Drag", desc: "Industry-leading aerodynamic efficiency" },
            ].map((feature) => (
