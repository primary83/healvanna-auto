...
const variants = [
  {
    name: "Zeekr 007 Rear-Wheel Drive",
    price: "$52,900",
    range: "438 mi",
    acceleration: "5.6s",
    topSpeed: "124 mph",
  ...
  {
    name: "Zeekr 007 All-Wheel Drive",
    price: "$58,900",
    range: "388 mi",
    acceleration: "3.5s",
    topSpeed: "143 mph",
...
const features = [
  {
    title: "Qilin Battery Technology",
    description: "Next-generation CATL Qilin battery for superior range and faster charging",
  },
  {
    title: "800V Fast Charging",
    description: "10% to 80% charge in just 15 minutes with ultra-fast charging",
  },
  {
    title: "Lidar Integration",
    description: "Advanced driver assistance with integrated lidar sensor array",
  },
  {
    title: "Zero-Gravity Seats",
    description: "NASA-inspired ergonomic seats with massage and ventilation",
  },
  {
    title: "Intelligent Cockpit",
    description: "Triple-screen layout with 8295 chip and voice AI assistant",
  },
  {
    title: "CD-Class Aerodynamics",
    description: "0.21 Cd drag coefficient for maximum efficiency",
  },
];

export default function Zeekr007Page() {
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <section className="pt-28 pb-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm mb-8">
            ...
            <span className="text-[#6b7a94]">Electric Sedan</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#8a9bb5] text-lg leading-relaxed mb-8">
                The executive electric sedan that sets new standards in range, performance, and luxury. 
                Featuring Qilin battery technology for class-leading efficiency.
              </p>

              {/* Key Stats */}
              <div className="flex items-center gap-8 mb-8">
                <div>
                  <p className="text-[#eaaa00] text-3xl font-light">$52,900</p>
                  <p className="text-[#6b7a94] text-sm">Starting Price</p>
                </div>
                <div className="w-px h-12 bg-[rgba(255,255,255,0.1)]" />
                <div>
                  <p className="text-white text-3xl font-light">438 mi</p>
                  <p className="text-[#6b7a94] text-sm">Max Range</p>
                </div>
                <div className="w-px h-12 bg-[rgba(255,255,255,0.1)]" />
                <div>
                  <p className="text-white text-3xl font-light">2.8s</p>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="https://www.zeekrlife.com/007"
                  target="_blank"
      ...
      <section className="py-20 px-6 md:px-12 bg-[#0d1424]">
        <div className="max-w-[800px] mx-auto text-center">
          <h2 className="text-2xl font-light mb-4">Protect Your Zeekr 007</h2>
          <p className="text-[#6b7a94] mb-8">
            Keep your executive sedan pristine with our premium care services.
          </p>
          <Link
            href="/care"
