...
export default function ZeekrPage() {
  // Zeekr Models with accurate specs
  const zeekrModels = [
    {
      id: 1,
      name: "001",
      category: "Electric Shooting Brake",
      image: "/cars/zeekr/001.png",
      range: "352 mi",
      acceleration: "3.8s",
      power: "536 hp",
      price: "$59,900",
      description: "The revolutionary shooting brake that redefined what an electric vehicle can be. Stunning design meets exceptional performance.",
      link: "/cars/zeekr/001"
    },
    {
      id: 2,
      ...
      power: "752 hp",
      price: "$52,900",
      description: "Executive electric sedan with class-leading range and Qilin battery technology for ultra-fast charging.",
      link: "/cars/zeekr/007"
    },
    {
      id: 3,
      name: "009",
      category: "Ultra-Luxury Electric MPV",
      image: "/cars/zeekr/009.png",
      range: "405 mi",
      acceleration: "4.5s",
      power: "536 hp",
      price: "$78,900",
      description: "The ultimate electric luxury MPV with first-class seating and a whisper-quiet cabin for discerning families.",
      link: "/cars/zeekr/009"
    },
    {
      id: 4,
      ...
      power: "536 hp",
      price: "$44,900",
      description: "Compact crossover with bold urban styling proving great things come in smaller packages.",
      link: "/cars/zeekr/x"
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      {/* Hero Stats Bar - Zeekr Gold Theme */}
      <section className="pt-28 pb-0">
        <div className="grid grid-cols-4 border-b border-[rgba(234,170,0,0.2)]">
          <div className="p-8 border-r border-[rgba(234,170,0,0.2)]">
            <div className="text-3xl font-light text-[#eaaa00]">4</div>
            <div className="text-sm text-[#6b7a94]">Models Available</div>
          </div>
          <div className="p-8 border-r border-[rgba(234,170,0,0.2)]">
            <div className="text-3xl font-light text-[#eaaa00]">438 mi</div>
            <div className="text-sm text-[#6b7a94]">Max Range</div>
          </div>
          <div className="p-8 border-r border-[rgba(234,170,0,0.2)]">
            <div className="text-3xl font-light text-[#eaaa00]">2.1s</div>
            <div className="text-sm text-[#6b7a94]">Fastest 0-60</div>
          </div>
          <div className="p-8">
            <div className="text-3xl font-light text-[#eaaa00]">800V</div>
            <div className="text-sm text-[#6b7a94]">Architecture</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-12">
        <div className="max-w-[1300px] mx-auto">
          <Link href="/cars" className="inline-flex items-center gap-2 text-[#6b7a94] text-sm mb-6 hover:text-[#eaaa00] transition-colors">
          ...
          <div className="flex items-center gap-6 mb-6">
            {/* Zeekr Logo */}
            <div className="w-20 h-20 bg-[#0a0f1a] rounded-2xl flex items-center justify-center p-3 border border-[rgba(234,170,0,0.3)]">
              <span className="text-[#eaaa00] font-bold text-3xl tracking-tight">Z</span>
            </div>
            <div>
              <h1 className="text-4xl font-light tracking-tight">Zeekr</h1>
              <p className="text-[#6b7a94]">Premium Electric by Geely</p>
            </div>
          </div>
          ...
          <p className="text-[#8a9bb5] max-w-[800px] leading-relaxed">
            ...
            exceptional performance, 800V ultra-fast charging, and innovative features across their growing lineup.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-12 bg-[#0d1424]">
        <div className="max-w-[1300px] mx-auto">
          <h2 className="text-2xl font-light tracking-tight mb-8">All Zeekr Models</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {zeekrModels.map((car) => (
              <Link 
                key={car.id} 
                href={car.link} 
                className="bg-gradient-to-b from-[rgba(15,22,40,1)] to-[rgba(10,15,26,1)] rounded-xl overflow-hidden cursor-pointer border border-[rgba(234,170,0,0.15)] hover:border-[rgba(234,170,0,0.4)] transition-all duration-400 hover:-translate-y-1.5 hover:shadow-[0_32px_64px_-16px_rgba(234,170,0,0.2)] group block"
              >
                <div className="h-48 overflow-hidden relative bg-gradient-to-br from-[#1a1f2e] to-[#0d1220]">
                  ...
                  />
                  {/* Zeekr Badge */}
                  <div className="absolute top-3 right-3 px-2 py-1 bg-[#eaaa00] text-[#0a0f1a] text-[9px] tracking-wider font-semibold rounded">
                    ZEEKR
                  </div>
                </div>
                <div className="p-5">
                  <div className="flex justify-between items-start mb-2">
                    <div className="text-[9px] tracking-[0.2em] uppercase text-[#eaaa00] font-medium">{car.category}</div>
                    <span className="text-[9px] tracking-[0.1em] uppercase px-2 py-1 bg-[rgba(234,170,0,0.15)] text-[#eaaa00] rounded-sm font-semibold">EV</span>
                  </div>
                  <div className="text-lg font-medium mb-1">Zeekr {car.name}</div>
                  ...
                  <div className="flex justify-between text-[11px] text-[#6b7a94] mb-4 py-3 border-t border-b border-[rgba(234,170,0,0.1)]">
                  ...
                  <span className="w-full py-2.5 text-[10px] tracking-[0.1em] uppercase font-medium border border-[rgba(234,170,0,0.3)] text-[#eaaa00] hover:bg-[rgba(234,170,0,0.1)] transition-all duration-300 rounded block text-center">
                    View Details
                  </span>
                </div>
              </Link>
      ...
      <section className="py-16 px-12">
        <div className="max-w-[1300px] mx-auto">
          <h2 className="text-2xl font-light tracking-tight mb-8">Why Choose Zeekr?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "800V Architecture",
                description: "Ultra-fast charging capability with up to 360kW charging power, going from 10% to 80% in just 15 minutes."
              },
              {
                title: "SEA Platform",
                description: "Built on Geely's Sustainable Experience Architecture, offering exceptional rigidity, safety, and performance."
              },
              {
                title: "Swedish Design DNA",
                description: "Zeekr's design center in Gothenburg brings Scandinavian minimalism and elegance to every model."
              }
            ].map((feature, index) => (
              <div key={index} className="bg-[rgba(15,22,40,0.5)] rounded-xl p-6 border border-[rgba(234,170,0,0.1)]">
      ...
      <section className="py-20 px-12 bg-[#0d1424]">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link href="/care" className="px-8 py-3 text-[13px] font-medium bg-[#eaaa00] text-[#0a0f1a] hover:bg-[#ffc832] transition-all duration-300 rounded">
              Explore Care Services
            </Link>
            <Link href="/cars" className="px-8 py-3 text-[13px] font-medium bg-transparent border border-[rgba(234,170,0,0.3)] text-[#eaaa00] hover:bg-[rgba(234,170,0,0.1)] transition-all duration-300 rounded">
              View All Brands
            </Link>
          </div>
        </div>
      ...
      <BrandHubSections brandSlug="zeekr" />
