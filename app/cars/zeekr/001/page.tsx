...
export default function Zeekr001Page() {
  const variants = [
    { name: "Zeekr 001 Long Range", price: "$59,900", range: "352 mi", acceleration: "5.9s", power: "272 hp", drive: "RWD" },
    { name: "Zeekr 001 Dual Motor", price: "$66,900", range: "328 mi", acceleration: "3.8s", power: "536 hp", drive: "AWD" },
    { name: "Zeekr 001 FR", price: "$89,900", range: "310 mi", acceleration: "2.1s", power: "1,247 hp", drive: "AWD", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">001</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Zeekr 001</h1>
            <p className="text-[#8a9bb5] text-lg mb-8 leading-relaxed">
              The revolutionary shooting brake that redefined what an electric vehicle can be. 
              Combining stunning Swedish-influenced design with exceptional performance and practicality.
            </p>
            
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#eaaa00]">$59,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">352 mi</div>
                <div className="text-sm text-[#6b7a94]">Max Range</div>
              </div>
              <div>
                <div className="text-3xl font-light">2.1s</div>
                <div className="text-sm text-[#6b7a94]">0-60 mph (FR)</div>
              </div>
            </div>
      ...
      <ChargingSection brand="Zeekr" model="001" slug="zeekr/001" range={352} theme="sapphire" />
      <MaintenanceSchedule brand="Zeekr" model="001" theme="sapphire" />
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Shooting Brake Design", desc: "Unique body style combining sedan elegance with wagon practicality" },
              { title: "800V Architecture", desc: "Ultra-fast charging with 360kW peak charging power" },
              { title: "Air Suspension", desc: "Adaptive air suspension with automatic leveling" },
              { title: "Yamaha Audio", desc: "21-speaker premium sound system with Dolby Atmos" },
            ].map((feature) => (
