...
export default function Zeekr009Page() {
  const variants = [
    { name: "Zeekr 009 Long Range", price: "$78,900", range: "405 mi", acceleration: "4.5s", power: "536 hp", drive: "AWD", seating: "6 Seats" },
    { name: "Zeekr 009 Grand", price: "$98,900", range: "385 mi", acceleration: "4.5s", power: "536 hp", drive: "AWD", seating: "4 Seats", highlight: true },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <div className="pt-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-[#6b7a94]">
            ...
            <span>/</span>
            <span className="text-[#e8edf5]">009</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-light mb-4">Zeekr 009</h1>
            ...
            <div className="flex gap-8 mb-8">
              <div>
                <div className="text-3xl font-light text-[#eaaa00]">$78,900</div>
                <div className="text-sm text-[#6b7a94]">Starting Price</div>
              </div>
              <div>
                <div className="text-3xl font-light">405 mi</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
            {variants.map((variant) => (
              ...
              >
                {variant.highlight && (
                  <div className="text-xs tracking-wider text-[#eaaa00] font-semibold mb-2 uppercase">Grand Edition</div>
                )}
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Executive Lounge", desc: "Captain chairs with massage, heating, cooling, and leg rests" },
              { title: "140 kWh Battery", desc: "Largest battery in class for exceptional range" },
              { title: "28-Speaker Audio", desc: "Dynaudio premium sound with 3D surround" },
              { title: "Dual Sunroof", desc: "Panoramic skylights with electrochromic dimming" },
            ].map((feature) => (
