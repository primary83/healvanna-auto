          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="bg-gradient-to-r from-[rgba(74,144,217,0.15)] to-[rgba(74,144,217,0.05)] border border-[rgba(74,144,217,0.25)] rounded-lg px-5 py-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-[10px] tracking-[0.15em] uppercase text-[#6b7a94] mb-0.5">Finding body shops for</div>
      ...
      <section className={`${vehicleParam ? 'pt-6' : 'pt-32'} pb-8 px-6 md:px-12`}>
        <div className="max-w-[1400px] mx-auto">
          ...
          <h1 className="text-[clamp(32px,5vw,56px)] font-extralight tracking-tight mb-4">
            {vehicleParam ? (
              <>
                <span className="font-semibold bg-gradient-to-r from-[#e8edf5] to-[#4a90d9] bg-clip-text text-transparent">{vehicleParam}</span> Body Shops
              </>
            ) : (
              <>
          ...
          <p className="text-[15px] text-[#6b7a94] max-w-[600px] leading-relaxed">
            {vehicleParam
              ? `Find certified collision repair specialists and body shops experienced with your ${vehicleParam}. OEM-quality repairs guaranteed.`
