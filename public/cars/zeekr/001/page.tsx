...
const features = [
  {
    title: "Shooting Brake Design",
    description: "Unique body style combining sedan elegance with wagon practicality",
  },
  {
    title: "800V Architecture",
    description: "Ultra-fast charging capability with 360kW peak charging power",
  },
  {
    title: "Air Suspension",
    description: "Adaptive air suspension with automatic leveling and adjustable ride height",
  },
  {
    title: "Frameless Doors",
    description: "Sleek frameless door design with soft-close function",
  },
  {
    title: "15.4\" AMOLED Display",
    description: "Massive central touchscreen with 2K resolution",
  },
  {
    title: "Yamaha Sound System",
    description: "21-speaker Yamaha premium audio system with Dolby Atmos",
  },
];
    ...
    <main className="min-h-screen bg-[#0a0f1a] text-[#e8edf5]">
      ...
      <section className="pt-28 pb-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm mb-8">
            ...
            <span className="text-[#6b7a94]">Electric Shooting Brake</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-8 mb-8">
                <div>
                  <p className="text-[#eaaa00] text-3xl font-light">$59,900</p>
                  <p className="text-[#6b7a94] text-sm">Starting Price</p>
                </div>
                <div className="w-px h-12 bg-[rgba(255,255,255,0.1)]" />
                <div>
                  <p className="text-white text-3xl font-light">352 mi</p>
                  <p className="text-[#6b7a94] text-sm">Max Range</p>
                </div>
                <div className="w-px h-12 bg-[rgba(255,255,255,0.1)]" />
                <div>
                  <p className="text-white text-3xl font-light">2.1s</p>
                  <p className="text-[#6b7a94] text-sm">0-60 mph (FR)</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="https://www.zeekrlife.com/001"
                  target="_blank"
      ...
      <section className="py-20 px-6 md:px-12 bg-[#0d1424]">
        <div className="max-w-[800px] mx-auto text-center">
          <h2 className="text-2xl font-light mb-4">Protect Your Zeekr 001</h2>
          <p className="text-[#6b7a94] mb-8">
            Keep your shooting brake looking stunning with our premium care services.
          </p>
          <Link
            href="/care"
